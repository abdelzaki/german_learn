...
- anpassen:
    - ich muss mir an die Umgebung anpassen 
...
- Abstrich:
    - der Abstrich 
    - wur müssen Abstrichhe hinnehmen 
...
- dauernd:
    - das Licht muss dauernd an blieben 
...
- verleugnen:
    - ich habe meine Herkunft nicht verleugnet 
...
- einerseits:
    - einerseits möchte ich gerne dort wöhnen andererseits kann ich mir das nicht leisten
...
- eskalieren:
    - das könnte zu einem Konflikt eskalieren 
