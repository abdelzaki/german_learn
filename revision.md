...
- anfallen:
    - ich kann mehr nicht vorstellen dass mehraufwand anfallen würde 
...
- verfangen:
    ...
    - meine Kleung haben sich in der Tür verfangen
...
- unterwerfen:
    - wir sind ständigen Veränderungen unterworfen [unterliegen]
...
- unterziehen:
    - ich muss mich diesem Test unterziehen damit ich den Pass erhalten [unterwerfen]
...
- bekanntmachen:
    - ich wollte dich mit diesem System bekanntmachen 
...
- heruntermachen:
    - ich will niemanden heruntermachen 
...
- hingehen:
    - es kann gerade so hingehen, aber morgen muss du kommen [akzeptiable]
...
- aufgehen:
    ...
    - mir geht es endlich auf dass ich einen Fehler gemacht habe[verstehen]
    - die Bind geht auf 
...
- hinauskommen:
    - ich wollte über das Gefühl hinauskommen 
    - ich will über den Punkt hinauskommen 
...
- drankommen:
    ...
    - das Thema ist heute drangekommen
...
- belegen:
    - ich belgege ein Vorlerung in Biologie [vorlesung_buchen]
...
- drauflegen:
    - legt man ein paar euro drauf und kann man etwas schönes kaufen 
...
- anschneiden:
    - ich wollte das Thema mit dir anschneiden (anreißen)
...
- feststecken:
    - ich stecke in alter Gesichte fest
...
- wegstecken:
    - er kann viel wegstecken 
    - ich habe den Fall weggesteckt 
...
- Kostenvoranschlag:
    ...
    - ich hätte gern einen Kostenvoranschlag 
...
- abschwatzen:
    - er hat mir mein Auto abgeschwatzt
...
- gleichstellen:    
    - ich werde dich mit ihm nicht gleichstellen
...
- anmerken:
    - ich will das anmerken 
    - das wollte ich angemerkt haben 
    - ich will etwas dazu anmerken  
    - ich muss mir das anmerken 
...
- Beitrag:
    - der Beitrag 
    - ich leiste großen Beitrag zu diesem Projekt 
...
- ausrechnen:
    - ich werde es schnell ausrechnen 
...
- versehen:
    ...
    - ich habe ihn mit Essen versehen 
...
- kleinbeigeben:
    - nach dem Streit hat er klein beigegeben
...
- durchfahren:
    - ich fahr durch (keine Pause)
    - ich fahre durch den Tunnel durch 
...
- herausfinden:
    - ich muss erst herausfinden wir es funktioniert 
...
- greifen:
    ...
    - das ist sehr hoch gegriffen [einschätzen]
...
- vorgreifen:
    - ich wollte dem Thema vorgreifen 
...
### weisen
- weisen:
    - ich weise ihm den Weg 
    - er hat mich gewiesen 
    - es weis in eine Richtung
    - er hat den Vorwurf von sich gewiesen 

- abweisen:
    - er weist meinen Antrag ab
    - er hat mich an der Tür abgewiesen 
    - die Karte wurde abgewiesen 

- anweisen:
    - du kannst ihn anweisen, die Sache zu machen 
...
- zurechtweisen:
    - er hat mich zurechtgewiesen[tadeln] 
...
- anmaßen:
    - ich würde mir nicht anmaßen dass ich weiss was in dir vorgeht 
...
- vorzeigen:
    - ich muss meinen Ausweis vorzeigen 
...
- Aufwand:
    - der Aufwand 
    - ich will nicht unnötigen Aufwand betreiben 
...
- ausräumen:
    - konnte ich deine Angst ausräumen 
...
- erkennen:
    ...
    - man kann den Typ des Systems an Artikel
...
- dazuholen:
    - ich muss jemanden von Pintsch dazuholen
...
- ersuchen:
    - ich habe dich ersucht ihm zu helfen 
...
- Arbeit:
    - die Arbeit 
    - ich will keine halbe Arbeit machen, ich versuche es gründlich zu machen 
...
- aufspielen:
    ...
    - ich werde es auf meinem Laptop aufspielen 
...
- durchspielen:
    - ich habe die Situaton durchgespielt aber ich habe keine Lösung gefunden  
...
- abweichen:
    - ich will nicht von der Regel abweichen 
...
- zurückweichen:
    - ich habe mich entschieden ich werde nicht zurückweichen 
...
- dazutun:
    - ich werde mehr Geld dazutun und ich kaufe ein besseres Autos 
...
- aneinandergeraten:
    - sie raten viel mit ihm aneinander 
...
- streichen:
    ...
    - Butter auf das Brott streichen 
...
- streifen:
    ...
    - ich habe ein anderes Auto gestreift 
...
- bestreiten:
    ...
    - ich will das Problem nicht leugnen 
...
- verändern:
    - er hat sich verändert [starte_Änderung]
...
- zuschreiben:
    - das habe ich mir zuzuschreiben 
...
- zurückkehren:
    - ich wollt zurück zum Thema kehren 
...
- beugen:
    ...
    - du muss dich einbisschen beugen 
...
- ansteuern:
    - er steuert eine Karrie im Automobil 
...
- absparen:
    - ich habe mir das Handy vom Taschengeld abgespart [abhungern]
...
- aussparen:
    - ich spare eine Zeile aus, und ich werde später dort etwas hinzufügen
...
- festbeißen:   
    - er hat sich an dieser Idee festgebissen 
...
- leiten:
    ...
    - ich lass mich nicht von Meinen Gefühlen leiten 
    - das leitet Strom 
...
- anklammern:
    ...
    - ich klammer meine Hoffnung an den Brief
...
- losgehen:
    - lass wir uns losgehen 

- loshaben:
    - er hat in diesem Bereich viel los
...
- verbinden:
    - ich kann nicht an Wifi verbinden 
...
- herausreißen: 
    ...
    - du kannst den Fehler nicht herausreßien (wettmachen) 

- hinreißen:
    - ich lass mich zu dieser Entscheidung nicht hinreißen 
...
### fühlen
- einfühlen:
    - ich kann mir in deine Situation einfühlen 
...
### harren
- harren:
    - ich harre der Dinge, die auf mich zukommen werden 
...
- anstrahlen:
    - ich werde das Gebaude anstrahlen 
...
- auflehnen:
    - er lehnt sich gegen die Regeln 
...
- hinwegblicken:
- hinwegsehen:
    - das hilft über dinge die nicht gerade gut laufen hinwegzusehen 
...
- vorherrschen:
    - diese Gedanken herrschen hier vor 
...
- hängenbleiben:
    - ich habe viel gelesen aber es bleibt am Ende nicht viel hängen 
...
- durchgreifen:
    - die Stadt muss gegen soetwas durchgreifen
...
- zusammensacken:
    - das Projekt sackt zusammen weil kein Geld vorhanden ist 
...
### ringen 
- abringen:
    - er hat mir das Versprechen abgerungen
...
- ausstatten:
    - ich werde dich mit warmer Kleindung ausstatten 
...
- einschreiten:
    - die Polizei hat gegen die Demo eingeschritten [eingreifen]
...
- entledigen:
    - ich will mich dieser Aufgabe entledigen 
...
- dazustoßen:
    - ich werde nach der Arbeit dazustoßen 
...
- geradebiegen:
    - ich biege es gerade was ich vorher verbockt habe 
...
- ausrollen:  
    - ich rolle die Karte aus [ausbreiten] 
...
- Antrag:
    - der Antrag 
    - ich habe einen Antrag auf Verlängerung der Frist gestellt
...
- Vorwurf:
    - der Vorwurf
    - ich mache dir keinen Vorwurf für diese Sache 
...
- Kontakt:
    ...
    - ich komme nicht in Kontakt zu ihm
    - ich wollte den Kontankt zum ihr aufrechterhalten 
...
- Arbeit:  
    ...
    - ich bin auf der Arbeit 
    - ich mache mich an die Arbeit 
    - ich will dich nicht beim Arbeiten unterbrechen 
...
- Massstab:
    - ich nehme mir das als Massstab
...
- loswerden:
    - ich wollte dieses Aufgabe loswerden
...
- Speisekarte:
    - die Speisekarte
    - könnten Sie die Speisekarte bringen
...
- Ausweis
    ...
    - du muss deinen Ausweis vorzeigen
...
- Kontakt:
    - der Kontakt
    - ich habe den Kontakt zum ihm abgebrochen 
...
- Format:
    - das Format 
    - in welchen Format die Informationen abgespeichert werden müssen 
...
- vorherschen:
- dominieren:
    - die Meinung herrscht hier vor 

- erst:
    - ich arbeite erst seit 3 Tagen in dieser Firma 

- schnüren:
    - ich werde das Paket schnüren 

- abschnüren:
    - die Hose schnürt mir den Magen ab 
...
- hinbleiben - Abriss - vorliegen - schwampig 
- sich an aufgabe machen 
- umbestritten 
- Leerlauf 
...
- Tat:*
    - die Tat 
    - ich lasse meinen Worten Taten lassen 
