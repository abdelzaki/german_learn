...
- Selbstüberwindung:
    - das kostet mich große Selbstüberwindung 
    - das ist eine echte selbstüberwindung das zu schaffen
...
### drängen
- drängen:
    - er drängen mich in die Ecke
    - er drängt mich zur Teilnahme
    - Mein Chef drängt auf die Einhaltung der Deadline
    - Wir können nicht länger warten, die Probleme drängen
...
- Gedränge:
    ...
    - im Gedränge seine Mutter verloren
...
- verplaudern:
    - wir haben uns verplaudert [sich]
...
- häppchen:
    ...
    - das wird in unregelmäßigen häppchen beezahlt
...
- zujubeln:
    - „Nach dem Konzert jubelten die Fans dem Sänger noch minutenlang zu
...
- verschlampen:
    ...
    - ich habe die Brille verschlampt 
...
- rausschießen:
    - das Blut schießt aus der Wunde raus 
    - die Sause kommt aus der Verpackung rausgeschossen
--
### ärgern 
- ärgern:
...
- muskelkater
    - der muskelkater
    - ich hatte so einen Muskelkater dass ich nicht laufen kann

- verkrampfen:
    - er verkrampt sich wenn Frauen das sind [versteifen]
    - verkrampfte Muskeln 
...
. krümeln:
    - das Brot krümeln 
    - du krümelst beim Essen 

- vollkrümeln:
    - du hast das Sofa vollgekrümlt
...
- stauchen:
    ...
    - ich habe mir den Fuß gestaucht [verstauchen]
...
- vorbeugen:
    ...
    - ich beuge mich vor um das zu erreichen
...
- schwören:
    ...
    - ich schwöre einen Eid ich habe das nicht gemacht 
...
- auswaschen:
    ...
    - der Regen hat den Weg ausgewascht 

- reinwaschen:
    - ich will meinen Name reinwaschen
...
- feuchtigkeit:
    - die Feuchtigkeit 
    - die Feuchtigkeit ist sehr hoch 

- anfeuchten:
    - ich feuchte die Kleidung an
...
- ablesen:
    ...
    - ich kann dir das vom Gesicht ablesen
...
- auf sich warten:
    ...
    - ich habe auf dich warten lassen 
...
- verbohrt:
    - mein Kind ist sehr verbohrt er Ändert nie seine Meinung [starrsinnig]
...
- zureden:
    - ich habe ihm gut / lange zugeredet bis ich das akzeptiert habe
...
- aussprechen:
    ...
    - Die Mehrheit sprach sich gegen das Projekt aus. [gegen/für]
...
- schweigen:
    ...
    - ich schweige über das Thema 

- ausschweigen:
    - ich habe mich über das Thema ausgeschwiegen 

- Tötschweigen:
    - ich habe einen Teil meiner Vergangheit totgeschwiegen 

- verschweigen:
    - er hat es mir verschwiegen dass er den Job verloren hat [unterschlagen] [vorenthalten]

- Schweigsam:
    - er ist Schweigsamer Mensch 

### heimlich 
- heimlich:
    - das ist eine heimliche Sache 

- unheimlich:
    - es ist mir unheimlich [nicht geheuer]
    - es ist mir nicht geheuer 

- verheimlichen:
    - er hat mir diese Sache verheimlicht 
    - er hat seine Pläne verheimlicht 
...
- anhören:
    ...
    - ich höre mir deinen Podcast an 
...
- reinhören:
    - Ich habe in das Hörbuch reingehört
...
- gutaussehend:
    - er ist ein gutaussehendes kind
...
- festfressen:
    ...
    - er hat sich in dieser Idee festgefressen [verharren] [verrennen] [versteifen] [fastfahren]
...
- überessen:
    - ich habe an etwas mich übergegessen 
...
- leerfressen:
    - er hat den halben Kühlschrank leergegessen
...
- abwegig:
    - die Idee ist abwegig [unplausbil]
...
- Trichter:
    - der Trichter 
    - ich bin endlich auf den Trichter gekommen 
    - ich brauche einen Tricher
...
- verwerflich:
    - Es ist verwerflich, die Notlage anderer Menschen auszunutzen, um Profit zu machen
...
- Zug:
    ...
    - das kann man im Zuge der Renevoierung machens
...
- überziehen:
    ...
    - ich habe das Meeting schon um 10 Minuten überzogen 
    - das Meeting hat die Zeit überzogen
...
- auszeichnen:  
    - Alle Artikel im Schaufenster müssen deutlich ausgezeichnet sein.
    - Eine Auszeichnung erhalten [prise]
...
- anführen:
    ...
    - er führt das Team an
    - willst du mich anführen lassen [verarschen]

- aufführen:
    - ich habe alles hier aufgeführt 
    - mehr Angaben sind hier nicht nötig, da die überigen bei Bedarf von den aufgeführten Beispielen abgeleitet
    werden
    - weiter hier nicht aufgeführte Punkte kann man bei Bedarf in die Datei finden 
    - führ dich nicht wie ein Kind auf (sich) 

- ausführen:
    - welche Programme werden gerade ausgeführt 
    - ich wollte gerade meine Idee ausführen [ausführlich]

- durchführen:
    - ich habe viele Projekte durchgeführt 

- einführen:
    - ich werde dich in meine Familie einführen 
    - ich will die neue Regel einführen 
    - der Artzt hat den Lauch in die Nase eingeführt

- entführen:
    - er hat ein Auto entführt
...
- herumführen:
    - der Weg führt um die Stadt herum 
...
- fortführen:
    - er will das Unternehmen fortführen 
    - ich will unsere Diskussion fortführen 

- Weiterführung:
    - die Weiterführung 
    - ich weiss nicht ob Weiterführung der Aufgabe Sinn macht

- irreführen:
    - ich will dich nicht irreführen 

- zurückführen:
    - der Fehler ist auf schlechte Verbindung zurückzuführen 

- zuführen:
    - dem Gerät wird kein Strom zugeführt
...
- abfahren:
    ...
    - ich bin voll auf Fußball abgefahren

- anfahren:  
- streifen:
	- ich habe beim Einparken ein anderes Auto gestreift / angefahren 
    - der Bus fahrt viel Bushaltestelle an 
    - ich fahre an

- auffahren:
    - er ist auf mein Auto aufgefahren (aufprallen)
    - er fährt sehr dich auf anderes Auto auf (dicht fahren) 
...
- durchfahren:
    - wir fahren durch einen Tunnel durch 
    - wir fahren durch 
    - ich haben Berlin durchfahren 

- einfahren:
    - wir habe gutes Ergebnis eingefahren

- erfahren:
    - hier erfahrt ihr Ahmed, und mohamed von meiner Aussage
    - ich habe erst Heute erfahren 

- festfahren:(sich)
    - das Auto hat sich im Sand festgefahren [verrennen] [verharren] [festbeißen]
    - ich fühle mich festgefahren

- hinfahren:
    - ich fahre dich dort hin 
...
- herumfahren:
    - ich fahre um den Stau herum 
    - ich fahre einfach herum 

- hinausfahren:
    - ich habe über die Ausfahrt hinausgefahren 
...
- überfahren:
    ...
    - ich habe ein Tier überfahren 
    - der Hund ist überfahren 
    - er hat die Ampel überfahren 

- zusammenfahren:
    - die beiden Autos sind zusammengefahren

- vorbeifahren:
    - er fährt sehr dicht an mir vorbei 

- kaputtfahren:
    - ich habe mein Auto kaputtgefahren 
...
- verfahren:
    - ich habe mich verfahren (sich)
    - wie sollen wir hier verfahren 
    - ich verfahre nach einem bestimmen Schema 
    - das ist eine verfahrene Situation 

- zerfahren:
    - LKW zerfahren die Straßen 

- wegfahren:
    - ich fahr weg 
    - ich fahre das Auto weg
...
- Erfahrung:
    - die Erfahrung 
    - ich könnte das in in Erfahrung bringen 
    - in erfahrung
        - jemand bringen 
        - etwas bleiben 
        - jemand behalten 
    - er hat viele Erfahrung 
    - 
...
- befinden:
    - wir befunden uns in einem Schlechten Zustand
    - das Büro befindet sich im zweiten Etage 

- herausfinden:
    - ich muss erst herausfinden wie es funktioniert 
    - meine Frau hat es herausgefunden dass ich fremdgegängen bin
...
- nachempfinden:
    - Wenn man selbst schon einmal in dieser Situation war, kann man das viel besser nachempfinden

- durchfinden:
    - ich finde mich durch die Stadt durch 

- zurechtfinden:
    - das ist sehr komplexes System, man findet sich in diesem System nicht schnell zurecht 

- vorfinden:
    - ich habe ihn in gutem Zustand vorgefunden 
...
- herfinden:
    - ich habe schnell hergefunden 

- stattfinden:
    - wann findet es statt 

- zusammenfinden:
    - ich habe immer gehoft dass wir uns wieder zusammenfinden  [treffen]
    - nach dem Streit wir haben wieder zusammengefunden
    - Das Team muss zusammenfinden
...
- Auftreten:
    - das Auftreten 
    - er hat sie gutes Auftreten 

- eintreten:
    - ich trete in die Partei ein [in]
    - ich trete für die leute ein [für] [verteidigen]
    - ob dieser Fall eintreten wird, weiss ich nicht 
    - Die Feuerwehr hat die Tür eingetreten, um das Kind zu retten

- austreten:
    - ich trete aus der Partei aus 
    - Er hat die Zigarette auf dem Boden ausgetreten

- beitreten:
    - ich trete diesem Verein bei 

- betreten:
    - das darf man nicht betreten 

- durchtreten:
    - trete die Bremse nicht durch 

- festtreten:
    - ich trete den Teppich fest 

- kürzertreten:
    - ich bin nicht mehr Jung, ich muss kürzertreten 
    - ich trete bei dem Job kürzer 

- übertreten:
    - ich trete zum Islam über [übergehen]
    - er hat das Gesetzt übertreten [verstoßen] 

- vortreten:
- zurücktreten:
    - tritt bitt vor / zurück

- zurücktreten:
    - Daniel und Christain werden nach und nach zurücktreten 
    - ich habe als Ziel reich zu werden. alles anders muss zurücktreten 
...
- anstoßen:
    ...
    - ich habe mir den Fuß am Tisch angestoßen 
    - ich habe ein Treffen angestoßen 
...
- dazustoßen:
    ...
    - du kannst gerne dazu stoßen wenn du Zeit hast
...
- zusammenstoßen:
- aneinanderstoßen:
	- gestern ist ein LKV mit dem auto zusammengestossen
...
- umstoßen:
    ...
    - er hat seine Pläne umgestoßen

- Anstoß:
    - der Anstoss 
    - ich hoffe nimmt niemand Anstoss an meiner Anwesenheit 
    - ich wollte keinen Anstoss erregen 
    - der Chef hat den Anstoß für das Projekt gegeben 
...
- rücken:
    ...
    - könntest du ein bisschen rücken damit ich sehen kann
...
- zurechtrücken:
    - ich versuchte den Konflikt zurechtzurücken 
...
- Griff:
    - der Griff 
    - ich habe alles im Griff [alles kontrollieren]
    - ich versuche das in den Griff zu bekommen
    - du musst an dem Griff drehen 

- griffig:
    - das ist sehr griffig 
...
- abgreifen:
    - ich werde das Signal abgreifen [signal messen]
    - er hat die Daten von den Kunden abgegriffen 
    - er hat das Geld abgegriffen

- abgegriffen:
- abgedroschen:
    - es ist abgegriffen, aber ich finde das Team sehr gut ist 
...
- angreifen:
    ...
    - Wir haben lange genug geplant, jetzt müssen wir das Problem aktiv angreifen.

- Angriff:
    - der Angriff 
    - der Angriff ist rechtfertigt 
    - ich will das Thema in Angriff nehmen [beginnen]

- aufgreifen:
    - ich will das Thema noch einmal aufgreifen 
    - ich wollte den richigen Moment aufgreifen 
...
- Begriff:
    - der Begriff 
    - ich habe keinen Begriff davon wie schwerig die Aufgabe ist 
    - ich war im Begriff das zu machen [drauf und dran]
    - dieser Name ist mir kein Begriff 

- durchgreifen:
- eingreifen:
    - die Polizei greift gegen die Demo durch [einschreiten]
    - ich will nicht in die Diskussion eingreifen 
...
- zurückgreifen:
    - wir können immer auf Plan B zurückgreifen 
...
- Zugriff:
    ...
    - ich kann keinen Zugriff auf diese Datei 
...
- Anweisung:
    - die Anweisung 
    - seine Anweisungen waren klar

- aufweisen:
    - Die Ware weist zahlreiche Mängel auf 
    - das neue Produkt weis hohe Qualität auf 
...
- erweisen:
    - er hat sich als guter Entwickler erwiesen 

- hinweisen:	
	- ich will dich/Sie darauf hinweisen 
	- Der Lehrer hat uns auf die Wichtigkeit von Hausaufgaben hingewiesen. 

- zuweisen:
    - das kannst mir direkt zuweisen 
...
- verweisen:
    - ich werde auf das alte Ticket verweisen
    - ich werde ihn an meinen Chef verweisen

- vorweisen:
    - muss soll das Ticket vorweisen
    - ich konnte gute Kenntnisse vorweisen
...
- nachweisen:
    - er hat mir meinen Fehler nachgewiesen 
    - es ist nicht nachgewiesen

- Hinweis:
    - der Hinweis 
    - das ist sehr guter Hinweis darauf dass etwas nicht simmt 
...
- Ausweis:
    - der Ausweis
    - ich muss den Ausweis vorweisen

- Ansatzweise:
    - ich habe das Konzepz Ansatzweise ausgearbeitet 
    - das erfüllt Ansatzweise die Anforderung 

- weise:
    - die Weise
    - ich kann das auf verschiedene Weise machen 

- Weise:
    - es ist ein weiser Mensch 

- Arbeitsweise:
    - die Arbeitsweise 
    - er hat sehr gute Arbeitsweise 
    
- Schrittweise:
    - wir können das schrittweise machen 
...
- Sichtweise:
    - die Sichtweise 
    - aus seiner Sichtweise heraus macht die Entscheidung Sinn 
    - er hat ein andere Sichtweise auf das Problem 
    - drei Personen heißen drei Sichtweise 
...
- davonlaufen:
    ...
    - man kann die Realität nicht davonlaufen
...
- ankommen:
    - Der Zug ist heute mit zehn Minuten Verspätung angekommen
...
- legen:
    ...
    - die Begeisterung hat sich ein bisschen gelegt [sich] 

- freilegen:
    - das Kabel ist freigelegt

- ablegen:
    - wo soll ich das ablegen 
    - ich habe die Prüfung abgelegt [do_exam]
...
- auslegen:
    - ich lege den Teppich aus [ausbreiten]
        - eine Wand mit Fliesen, eine Decke mit Holz auslegen
    - könntest du mir für das Essen auslegen [geld]
    - Das Stadion ist für / auf 10.000 Zuschauer ausgelegt. [für]
...
- einlegen:
    ...
    - ich würde hier ein Veto / pause einlegen 
...
- verlegen:
    ...
    - Da er mit logischen Argumenten scheiterte, verlegte er sich auf emotionale Erpressung
...
- zurücklegen:
    ...
    - Wie viele Meilen habt ihr auf eurer Weltreise insgesamt zurückgelegt?
...
- Anlage:
    ...
    - klimaanlage 
    - siehe Anlage 
    - in der Anlage der Email
    - er hat eine Anlage zur Musik
    - Die analytische Anlage hilft im Beruf.
    - Er hat eine starke Anlage zum Übergewicht, weshalb er sehr auf seine Ernährung achten muss

- lage:
    - die Lage 
    - die Lage ist nicht sehr gut

- Lager:
    - das Lager 
    - wir haben das Auf Lager 
...
### liegen 
- liegen:
    - diese Art leigt mir nicht [sich]
...
- reißen:
    ...
    - ich reiße den Bildschirm an mich [an]
...
- herumreißen:
    - sie hat ihn herumgerissen 
    - Er packte ihn an der Schulter und riss ihn zu sich herum
...
- anstecken:
    - ich habe mich mit Grippe angesteckt 

- aufstecken:
    - ich werde nicht aufstecken ich muss weitermachen (schlappmachen)
    - das Display kann man einfach aufstecken 
    - Bei diesem Computer-Modul muss man die Erweiterungskarte vorsichtig auf die Pins aufstecken
    - Die Beleuchtung am Fahrrad ist nur aufgesteckt und kann zum Schutz vor Diebstahl leicht abgenommen werden.

- Besteck:
    - das Besteck
    - wo finde ich das Bestecke 
...
- einstecken:_
    - er hat das Geld schnell eingesteckt
...
- zustecken:
    ...
    - sie hat gerade Geld zugesteck [in die Hose]
...
- herumschlagen:
    - herumärgern
    - ich habe mich mit diesem Problem herumgeschlagen 
...
- Anschlag:
    ...
    - ich öffne die Tür bis zum anschlag [einrasten]
...
- hauen
    - er hat mich gehauen 
    - er haut einfach seine Sache 
    - Sie hauen sich 

- abhauen:
    - ich haue ab 
    - ich habe den Ast abhauen

- anhauen:_
    - er hat mich um Geld angehauen [anpumpen]
    - ich habe mich an dem Tisch angehauen 

- durchhauen:
    - ich haue den Ast durch 

- hinhauen:
    - das hat leider nicht hingehauen 
    
- raushauen:
    - er hat 100 Euro für die Schuhe rausgehauen
    - was dann hau raus 

- reinhauen:
    - er hat mir eine reingehauen [ins geischt schlagen]
    - hau rein (essen)
    - wir müssen reinhauen um das zu schaffen [zupacken]
    - das hat bei mir richtig reingehauen [starke Wirkung hat]
...
- tragfähig:
    - die Wände sind nicht trägfähig
...
- freihalten:
    - ich halte den Platz für dich frei

- hinhalten:
    - du hast mich genug hingehalten 
    - ich versuche ihn hinzuhalten bis du kommst 
    - den Kopf / die Hand für ihn hinhalten [ausbaden] 
    - ich halt mir die Kleidung hin

- herhalten:
    - er muss als Sündenbock für das Problem herhalten 
    - ich muss immer für die Verspätung andere Leute herhalten 
...
- vorenthalten:
    - er hat mir diese Informationen vorenthalten [unterschlagen] [verschweigen] [verheimlichen] 
...
- Aufenthalt:
    - der Aufenthalt 
    - ich hatte einen angehnemen Aufenthalt 

- Rückhalt:
    - der Rückhalt 
    - du hast meinen Rückhalt wenn du probleme hast 
...
- dabeihaben:
    - ich habe mein Handy leider nicht dabei 

- dahaben:
    - haben wir immer noch Essen da [zur Verfügung stehen]
...
- gernhaben:
    - ich habe ihn gern aber ich mag dich nicht 

- Guthaben:
    - das Guthaben 
    - ich will das Guthaben auflösen 

- handhaben:
    - wie soll ich dieses Gerät handhaben 
    - das Gerät lässt sich nicht einfach handhaben 
    - wie hast du das Problem gehandhabt 
    - ich will das Ticket anders habenhaben 
...
- schwerhaben:
    - ich habe es schwer ihn zu überzeugen 

- rechthaben:
    - du hast recht 

- wahrhaben:
    - ich will nicht wahrhaben dass ich einen Fehler gemacht habe 
...
### stellen 
- stellen:
    - er hat mir ein Paar Fragen zum Thema Geld gestellt 
    - ich wollte es zur Diskusssion stellen 
    - er stellt hohe Ansprüche an mich 
    - ich habe ihn vor eine Wahl gestellt 
...
- anstellen:
    ...
    - ich habe alles angestellt um das zu schaffen 
    - ich kann erkennen wenn mein Kind etwas angestellt hat 
    - er stellt sich beim Autofahren so an als er keine Ahnung hat 
...
- einstellen:
    - dieses Produkt wird eingestellt (etwas)
    - wir stellen neue leute ein (jemanden)
    - ich muss mich auf die Schlimmste einstellen (sich)
...
- gleichstellen:    
    - ich werde dich mit ihm nicht gleichstellen [gelichsetzen] [Äquivalent]
    - sie sind nicht gleichgestellt  

- Gleichstellung:
    - die Gleichstellung von Männer und Frauen

- herstellen:
    - ich muss erst die Verbindung herstellen 

- herausstellen:
    - es hat sich herausgestellt dass er Recht hat 
    - der Chef hat herausgestellt wie wichtig das Team work ist 

- nachbestellen:
    - du kannst du immer nachbestellen 

- nachstellen:
	- Der Chef stellt seiner Sekretärin nach
    - ich muss die Bremse nachstellen 
...
- richtigstellen:
    - ich will diesen Irrtum richtigstellen

- sicherstellen:
    - ich wollte sicherstellen dass ich alles richtig verstanden habe 

- verstellen:
    - ich habe vielleicht das Buch verstellt 
    - er hat sich verstellt 

- vorstellen:
    - ich kann mir das so vorstellen 
    - er hat mich ihrer Familie vorgestellt 
    - ich hatte mir das anders vorgestellt 

- umstellen:
    - die Heizung auf Sommerbetrieb umstellen

- feststellen:
    - wir haben festgestellt dass es nicht möglich ist 
    - wir haben das Problem festgestellt 

- freistellen:
    - der Chef hat mich für den Fortbildungslehrgang freigestellt (akku)
    - ich stelle es dir frei, ob du kommen willst oder nicht

- unterstellen:
    - ich will dir nichts unterstellen

- zurückstellen:
    - wir haben kein Geld gerade, wir stellen den Urlaub zurück
...
- einstellig:
    - das ist eine einstellige Nummer 
...
- setzen:
    ...
    - ich werde das Kinder in den Kinderwagen setzen 
    - ich habe meine Hoffnung darauf gesetzt 
    - in Betrieb / Außer Betreib setzen 
    - in Gang setzen 
...
- aufsetzen:
    ...
    - ich werde den Kaffe aufsetzen
    - Brille aufsetzen

- aussetzen:
    - ich wollte meine Haut der Sonne aussetzen 
    - ich werde mit der Arbeit aussetzen  
    - ich habe an ihm nichts auszusetzen 

- besetzen:
    - das ist aber besetzt [belegen] 

- daransetzen:
    - ich habe alles darangesetzt um das zu schaffen 

- durchsetzen:
    - er hat sich gegen mich durchgesetzt 

- einsetzen:
    - ich habe mich bei dem Chef für dich eingesetzt
    - ich habe mich für diese Aufgabe eingesetzt 
    - wir sollen ein Fenster in das Dach einsetzen lassen 

- entsetzen:
    - diese Nachricht hat mich entsetzt [schockitert]

- ersetzen:
    - ich wollte mein Auto ersetzen

- festsetzen:
    - der Gerauch hat sich in der Kleindung festgesetzt
    - die Idee hat sich in seinem Kopf festgesetzt
...
- gleichsetzen:
    - du kannst beides nicht gleichsetzen [gleichstellen]

- hineinversetzen:
    - ich kann mich sehr gut in deine Situation hineinversetzen [einfühlen] [hineindenken]
...
- voraussetzen:
    - Wir setzen ausgezeichnete Computerkenntnisse voraus
...
- widersetzen:
    - sie haben sich der Besetzung widersetzt

- versetzen:
    - sie hat mich versetzt 
    - ich wurde nach Hamburg versetzt 

- zusetzen:
    - mir hat die Hitze zugesetzt 
    - ich werde dem Wasser den Zucker zusetzen 

- Ersatz:
    - der Ersatz
    - ich muss einen Ersatz finden 
    - A kann durch B ersetzt

- zusammenbauen: 
- zusammensetzen:   
    - das kann man schnell zusammenbauen

- auseinandersetzen:
    - ich muss mich mit dem Thema auseinadersetzen 
    - ich setze dir das Thema auseinander
    - ich nehme mir Zeit und ich setze mich mit dieser Aufgabe zueinander
...
- zusatz
    - der zusatz
    - das kann man durch zusatz von Chlor sauber machen 

- vorgesetzter: 
    - der Vorgesetzter
    - er ist mein unmittelbar vorgesetzter 
...
- sitzen:
    ...
    - am kürzeren / langeren Hebel sitzen 

- lassensitzen:
    - ich kann das nicht auf mir sitzen lassen [auf]
    - wir haben eine Verabredung aber sie hat mich sitzen lassen
...
- besessen:
    - ich bin von dieser Idee besessen
...
### schöpfen
- schöpfen:
    - ich konnte Energie aus meinem Glauben schöpfen 
    - Wasser aus dem Behälter schöpfen

- auschöpfen:
    - ich wollte alle Möglichkeiten ausschöpfen

- abschöpfen:
    - ich werde den Gewinn ab 
...
- unerschöpflich:
    - meine Energie ist unerschöpflich 
...
- Beben:
    - das Beben 
    - ich konnte das Beben verspüren 

- erbeben:
    - das Haus erbebt wegen des LKVS

### schütteln
- schütteln:
    - ich schüttle die Flasch vor dem Öffnen 

- aufschütteln:
    - ich schüttle die Decke auf 

- abschütteln:
- ausschütteln:
    - ich schüttle die Jacke ab 
    - ich schüttle meine Angst ab 
...
- Punkt:
	- der Punkt
	- ich habe den Punkt erreicht, an dem ich eine Entscheidung treffen muss
...
- Treffpunkt:
    - der Treffpunkt 
    - wir haben am Bahnhof Treffpunkt vereinbart

### knacken
- knacken:
    - ich habe das Rätsel geknackt 

- verknacken:
    - der Täter wird verknackt 

- Knackpunkt:
    - der Knackpunkt 
    - das ist genau der Kanckpunkt 
...
- abnicken:
    - der Voeschlag wird abgenickt 

- einnicken:
    - ich werde kurz einnicken 

- zunicken:
    - sie hat mir zugenickt

- knicken:
    - der Wind hat die Bäume knickt 

- einknicken:
    - ich werde nicht wegen des Drucks einknicken 
    - mein Knie ist eingeknickt 

- umknicken:
    - der Baum knickt Baum 
    - der Wind knickt den Baum um 
    - ich bin mit den Fuss umgeknickt 
...
### spalten
- spalten:
    - das hat das Land gespaltet 

- abspalten:
    - wir haben uns von der Firma abgespaltet 
...
### steuern
- steuern:
    - so kann man das Auto steuern 
    - das wird vom Computer gesteuert
    - bauchgesteuert 
    - Kopfgesteuert

- ansteuern: [zustreben]
    - er steuert eine Karrie im Automobil an
...
- gegensteuern:
    - ich steuere dem Trend gegen 

- zusteuern:
    - wir steuern auf ein Problem zu

- versteuern:
    - ich muss das leider versteuern 

- steuer:
    - die Steuer
        - ich muss Steuer bezahlen 
...
- hängenbleiben:
    ...
    - meine kleidung ist am Tür hängen geblieben
...
- abhängig:
    - ich bin vom deiner Entscheidung abhängig

- anhängen:
    - ich hänge den Wagen an den Zug an
    - ich habe meinen Lebenslauf an die Email als PDF angehängt 
    - ich werde den Urlaub an die Reise anhängen 
...
- anhänglich:
    - ich habe ein Kind im Alter von 5 Jahren die sehr anhänglich ist 
...
- herumhängen:
    - er hängt einfach herum und macht nichts wichtiges 

- herunterhängen:
    - seine Haar hängt herunter

- zusammenhängen:
    -  ich glaube das hängt mit der Umgebung zusammen 
    
- nachhängen:
    - er hängt den alten Zeiten nach 
    - ich will diesen Gedanken nicht nachhängen

- weghängen:
    - ich hänge den Mantel weg 

- verhängen:
    - die Sperrung wird verhängt 

- Verhängnis:
    - das Verhängnis 
    - das könnte mir zum Verhängnis

- verhängnisvoll:
    - die Entscheidung war verhängnisvoll 

- vorhang:
    - der vorhang

- durchhangeln:
    - ich muss mich durch viele Seite durchhangeln um das zu finden

### ragen
- ragen:
    - es fängt an über den Wassespiegel zu ragen 

- herausragen:
- hervorragen:
    - er ragt aus der Masse heraus 
...
- widerspiegeln:
    - das spiegelt deine Absichten wider 
    - das spieglt die heutige Realität nicht wider 
    - die Unzufriedenheit spiegelt sich in der zunehmenden Gewalt wider
...
- Anmerkung:
    - die Anmerkung 
    - ich habe eine Anmerkung zu dem Thema 
...
- markieren:
    - meine Antwort ist farblich markiert 

- aufmerksam:
    - ich wollte dich darauf aufmerksam machen 
    - danke sehr, das war sehr aufmerksam von dir 

- Markenkleidung:
    - die Markenkleidung 
    - er trägt Markenkleidung 

- Briefmarke:
    - die Briefmarke 
    - haben sie bitte Briefmarke 
...
- prägen:
    ...
    - diese Beziehung ist von kurzer Dauer geprägt

- einprägen:
    - ich habe mir das eingeprägt 
    - die Wörter haben sich mir eingepragt 
...
- einschliessen:
    ...
    - ich habe aus versehen mich eingeschlossen
...
- entschließen:
    - wir haben uns entschlossen das Haus zu kaufen 
...
- erschließen:
    - ich kann diese logik nicht erschließen 
    - das Gebiet ist nicht gut erschlossen 
    - wir wollten neue Märkte erschließen 
...
- zusammenschließen:
    ...
    - wenn wir uns zusammenschließen werden wir die größte Firma der Welt 
...
- verschlüsseln:
    - ich habe die Nachtricht verschlüsselt 
...
- Rechnung:
    - die Rechnung 
    - Sie haben mir 10 Euro in Rechnung gestellt 
    - ich habe die Rechnung bezahlt
    - wir tragen den Bedürfnissen der Kunden Rechnung [rechnung tragen]
    - das geht auf meine Rechnung [geht auf meine Rechnung] 
    - ich mache dir keinen Strich durch die Rechnung [strich]

- Rechenschaft:
    - die Rechenschaft 
    - du bist niemandem darüber Rechenschaft schüldig

- abrechnen:
    - ich werde das mit ihm abrechnen 
    - die Fahrkosten werden am Monatsende abgerechnet 
    - ich werde das von dam abrechnen

- Abrechnung:
    - die Abrechnung 
    - ich mache die Abrechnung 
    - Gehaltsabrechnung / Reisekosten-Abrechnung / in Abrechnung nehmen

- anrechnen:
    - ich rechne dir das alte auto auf das neue an 
    - ich rechne dir das alte Auto mit 500 euro an
    - ich habe ihm seine Hilfe hochgerechnet 

- ausrechnen:
- errechnen:
    - ich rechne aus wie lange es dauert

- berechnen:
    - sie habe mir 10 Euro für die Reparature berechnet 
    - das wird automatisch berechnet 

- berechnend:
    - er ist sehr berechend 

- einrechnen:
    - kinder sind nicht eingerechnet 

- hochrechnen:
    - wenn man das hochrechnest , kommt man auf folgendes 

- verrechnen:
    - ich habe mich leider verrechnet 
    - ich würde gerne den Gutschein mit dem Preis verrechnen 

- errechnen:
    - das kann man schnell errechnen 
    - der errechnete Betrag ist nicht korrekt 
...
- Zahl:
    - die Zahl , Zahlen 
    - er hat keine Zahlen genannt 
    - die Zahlen sind nicht gut 
    - die Zahl der Leute ist gestiegen [nicht-plur]
    - das ist gerade Zahl 
...
- zahlen:
    - ich habe ihm 4 Euro für etwas gezahlt
    - ich will zahlen 
    - sie zahlen gut 
    - ich bin gut gezahlt 

- bezahlen:
    - ich würde in Raten bezahlen 
    - ich bezahle das Essen
    - ich habe ihn für seine Arbeit bezahlt 
    - ich habe ihm das Studium bezahlt
...
- abbezahlen:
- abzahlen:
    - ich will das Auto abbezahlen 

- anzahlen:
    - ich muss auf das Auto 300 Euro anzahlen 

- Anzahl:
    - die Anzahl 
    - er zeigt die Anzahl der Schritte 

- Anzahlung:
    - die Anzahlung 
    - die Anzahlung ist sehr hoch 

- aufzahlen:
- zuzahlen:
    - man must dafür aufzahlen 
...
- auszahlen:
    ...
    - ich will mir auszahlen lassen 

- draufzahlen:
    - ich muss draufzahlen 

- einzahlen:
    - ich zahle Geld auf mein Konto ein 

- nachzahlen:
    - ich müss leider nachzahlen 
...
- abzählen:
    - ich zähle ab wie viel Männer da sind 

- aufzählen:
    - ich habe dir die Möglichkeiten aufgezählt [aufführen] 

- erzählen:
    - er hat mir erzählt dass er keine Zeit hat 

- nachzählen:
    - Zähl lieber das Geld noch einmal nach!
...
### werben
- werben:
    - wir werben für dieses Produkt 
    - er wirbt um ihre Liebe 

- abwerben: 
- anwerben:
    - viele Firmen veruschen ihn von der Firma abzuwerben 
    - die Firma hat ihn angeworben 

- bewerben:
    - ich habe mich um diese Stelle beworben

- umwerben: 
    - sie haben versucht mich zu umwerben 
...
### lasten 
- lasten:
    - ich wollte auf dir nicht lasten 
...
- überlasten:
    - ich wollte meinen Körper nicht überlasten 

- entlasten:
    - ich wollte meine Frau bei Hausarbeit entlasten 

- auslasten:
    - ich bin mit der Arbeit ausgelastet 
    - ich bin zu 20 % ausgelastet
...
- Altlast:
    - die Altlast 
    - wir müssen die Altlasten abarbeiten
...
### brauchen 
- brauchen:
    - ich brauche meine Kraft um das zu machen 

- aufbrauchen:
    - ich habe mein ganzes Geld aufgebraucht 

- verbrauchen:
    - es verbraucht viel Benzin 
...
- Gebrauch:
    - der Gebrauch
    - wenn Sie von das keinen Gebrauch macht, ist das nicht mein Problem 
    - vor Gebrauch muss man die Flasche schütteln 
...
- hängenbleiben:
    - ich habe viel gelesen aber bleibt am Ende davon wenig hängen 

- steckenbleiben:
    - wenn man nicht viel arbeitet bliebt man stecken 
    - ich bin leider steckengeblieben 

- offenbleiben:
    - es bleibt offen ob er kommen wird oder nicht 

- überigblieben:
    - ist jemand übringgeblieben 

- verbleiben:
    - nach Abzug verbleibt nur 700 Euro 
...
- abgeben:
    - ich will mich mit soetwas nicht abgeben [sich]
    - ich muss das bei HR abgeben [bei]
...
- angeben:
    - du muss immer den Verwendungszweck angeben wenn du Geld Überweisung
    - er gibt mit seinem auto immer an 
    - das gibt die Temperaure in C an 
    - es wird das angegebene Parameter verwendet 
    - es muss in einer folgenden Formen angegeben werden
...
- angeblich:
    - er ist angeblich Reich 

- aufgeben:
    - ich gebe nicht auf 

- ausgeben:
    - ich gebe für mein Hobby viel aus
    - wie viel gibst du für Essen aus 
    - er gibt es als seinen Plan aus 

- dazugeben:
    - er gibt seinen Senf dazu

- rausgeben:
    - haben Sie es Passend ? ich kann leider nicht rausgeben 
    - kannst du auf einen Hunderter(100) rausgeben

- eingeben:
    - ich habe das Passwort eingegeben
    - ich muss ihm das Medikament alle 3 Stunden eingeben 
    - folgende Befehle koennen eingegeben werden

- ergeben:
	- die Untersuchung hat ergeben dass 
	- aus der Untersuchung hat sich ergeben dass 
	- das ergibt keinen Sinn
	- es hat sich nicht ergeben

- begeben:
    - ich begebe mich an die Arbeit / an die Fehlersuche / Umsetzung
    - ich will dich nicht in Gefahr begeben 
...
- Hingabe:
    - die Hingabe
    - ich mache das mit Hingabe 

- nachgeben:
- kleinbeigeben: [kleinbekommen]
    - ich werde nicht nachgeben 
    - nach dem Streit hat er klein beigegeben [nachgeben]

- rechtgeben:
    - ich muss dir rechtgeben dass ich einen Fehler gemacht habe 

- übergeben:
    - ich werde es an ihn übergeben 

- übergeben:(sich)
    - ich will mich übergeben 

- gasgeben:
    - wir müssen gasgeben sonst sonst schaffen wir es nicht 
...
- zufriedengeben:
    - ich gebe mich mit dieser Wohnung zufrienden wenn sie einen Balkon hat 
    - wir müssen uns nicht zufriedengeben
...
- beigeben:
    - ich gebe dem Brief ein Foto bei 

- ausgiebig: [ausführlich]
    - wir haben ausgiebig gefeiert 
    - die Implementierung war ausgiebig genüg

- ergiebig:
    - der Boden ist sehr ergiebig und bringt gute Ernte hervor 
...
### lösen 
- lösen:
    - ich kann das Problem nicht einfach lösen 
    - er hat sich von seiner eltern
    
- ablösen:
    - ich werde dich ablösen [einspringen]

- auflösen:
    - Zucker löst sich in Wasser auf 
    - ich will mein Konto auflösen 

- auslösen:
    - was hat den Streit ausgelöst 

- einlosen:
    - ich hat sein Versprechen nicht eingelöst 
    - ich will das Pfand einlösen 

- erlösen:
    - das erlöst mich aus dieser Situation 
...
### ander
- auseinandergehen:
    - nach 10 Jahren gehen wir auseinander 
    - geh auseinander [beim prügeln]
...
- aneinandergeraten:
    - ich will nicht mit ihm aneinadergeraten 
...
- anders:
    ...
    - aus der Ferne sieht alles gut aus, schaut mal ein bisschen näher hin sieht es anders aus 

- der ein oder der andere:
    - der ein oder der andere kann das machen 
    - für den einen oder den anderen könnte es interessant sein
...
- zuverlässig:
	- ich will ein zuverlässiges Auto #

- nachlässig:
- fahrlässig:
    - dein Verhalten war nachlässig 
...
- wechselhaft:
    - sie hat wechselhaften charakter

- abwechseln:
    - wir konnen uns bei dem Training abwechseln

- verwechseln:
    - nicht verwechseln 
    - ich habe meinen Schlussel verwechselt 
...
- umwechseln:
    - einen Schein in Münzen umwechseln

- Abwechlung:
	- die Abwechslung
	- zur Abwechslung mache wir es
	- ich brauche Abwechslung 

- Wechsel:
    - im wechsel = abwechsel
    - der Wechsel 
    - Jobwechsel 
    - Ortswechsel 
    - Ölwechsel
...
### schaffen 
- abschaffen:
    - wir müssen das Gesetz abschaffen 

- erschaffen:
    - Gott hat mich erschafft 

- beschaffen:
    - soll ich dir etwas besorgen 

- anschaffen:
    - ich werde mir ein Auto anschaffen 
...
- sache:
    - die Sache 
    - was hältest du von den ganzen Sachen 
...
### acht
- Acht:
    - ich nehme mich in Acht vor Dieb 
    - bitte nimm dich in Acht dass es hier gefährlich ist 

- achtlos:
    - er hat es achtlos weggeworfen
...
- beachten:
    - ich beachte die Regel [ignorieren]

- ignorieren:
    - das kann man öft einfach ignorieren

- beobachten:
    - ich beobachte Vogel 
    - ich muss das Kind immer beobachten 

- verachten:
    - ich verachte ihn weil er hat mich angelügt 

- missachten:
    - du hast die Regel missgeachtet 
...
- Herz:
    ...
    - ich kann das über das Herz nicht bringen
    - von Herzen 
    - das nehmen ich mir zu Herzen

- Geischt:
    - das Gesicht 
    - ich habe ihm das ins Gesicht gesagt
    - er hat ein hübsches Gesicht 

- Stirn:
    - die Stirn 
    - ich wische den Schweiß von der Stirn 
    - er hat die Stirn 

- Nase:
    - die Nase 
    - jemandem vor der Nase herumtanzen
    - ich muss ihm diese Information unter die Nase reiben 
    - ich habe die Nase voll 
    - ich wollte das machen aber er hat mir das vor der Nase weggeschnappt 
    - ich muss ihm immer die Informationen aus der Nase ziehen 
    - sie hat die Nase vorn 

- Haar:
    - das Haar / die Haare 
    - ich wollte meine Haare schneiden lassen 
...
- Bein:
    - das Bein 
    - ich wollte auf eignen Beinen stehen 
    - ich stelle dir kein Bein
    - er stellt uns ein Bein 
    - ich reiße mir hier ein Bein für dich aus, und du kannst nicht Danke sagen

- Knie:
    - das knie 
    - ich will nicht die Entscheidung über das Knie brechen

- Kopf:
    - der Kopf 
    - mein Kopf tut weh
    - das sollen wir im Hinterkopf halten

- Auge:
    - das Auge
    - das könnte schnell ins Auge gehen 
    - das sollen wir ins Auge fassen 
    - das erste die mir ins Auge gesprungen was ihre Kleidung
    - ich habe Ziel vor Augen
    - das wöllte ich mir vor Augen führen 
    - ich will ihn nicht aus den Augen verlieren
    - wir wollten das nicht aus den Augen lassen
    - dann fängt er an die Augen zu verdrehen

- Ohr:
    - das Ohr 
    - es ist auf einem Ohr taub
...
- Schulter:
    - die Schulter
    - er wird mir über die Schulter schauen  

- Hals:
    - der Hals 
    - ich habe einen Schal um den Hals 
...
- Arm:
    - der Arm 
    - er wollte mich auf den Arm nehmen 
    - kannst du mir unter die Arme greifen 
    - sie gehen Arm in Arm 
    - ich konnte ihm dieses Mal in den Arm fallen

- Fuß:
    - der Fuß
    - es ist 10 Minuten zu Fuß
    - ich will niemandem auf die Füße treten 
    - er fühlt sich leicht auf die Füße getreten
    - das wird mir später auf die Füße fallen
...
- Bauch:
    - der Bauch 
    - ich habe einen Bauch angesetzt 
    - ich befühle deinen Bauch

- Magen:
    - der Magen 
    - das darf man nicht auf nüchternen Magen essen 
    
- Glatze:
    - die Glatze 
    - ich habe eine Glatze bekommen

### wirken 
- wirken:
    - du wirkst sehr müde 
    - wir wirkst du auf sein Gegenüber 
    - das Medikamment wirkt gut gegen Schmerzen 

- Wirkung:
    - das Medikament hat eine schnelle wirkung 

- auswirken:
    - er wirkt sich sehr gut auf die Kinder aus 

- Auswirkung:
    - die Auswirkung 
    - es hat sehr gut Auswirkung auf die Gesundheit 

- bewirken:
    - das bewirkt das genau das Gegenteil 
    - das könnte eine Änderung bewirken  
...
- nachwirken:
    - das wirkt immer nach 

- mitwirken:
    - das hat mitgewirkt 

- zusammenwirken:
    - viele Dinge wirken zusammen 

- weiterwirken:
    - das wird weiterwirken 

- zurückwirken:
    - das wird auf mich zurückwirken 

- Wechselwirkung:
    - die Wechselwirkung zwischen Menschen und der Natur 
...
- fassen:
    ...
    - ich wollte in der Familie Fuß fassen [stabilität]
    - ich brauche Zeit um in der neuen Ungebung fuss zu fassen 
    - Der Bergsteiger suchte vorsichtig nach einem festen Stein, um Tritt zu fassen

- Fassung:
    - die Fassung [lampe_fassung] 

- fassbar:
- unfassbar:
    - das ist unfassbar schwer 
    - ich brauche etws fassbar 

- abfassen:
- verfassen:
    - ich werde einen Berich abfassen 
...
- erfassen:
- auffassen:
    - ich habe die Lage erfasst
    - wie soll ich das auffassen [verstehen]

- Auffassung:
    - die Auffassung 
    - ich bin der Auffassung dass wir das machen müssen

- befassen:
    - mit diesem Thema müss ich mich befassen 
...
- reinfassen:
    ...
    - ich fasse in den Sack rein und schaue ob wir es haben
...
- rühren:
    ...
    - du muss die Suppe rühren

- anrühren:
    - wir dürfen hier nichts anrühren 

- berühren:
    - das hat mich berührt 
    - ich habe das Thema nicht berührt 
    - er hat einen Punkt in mir berührt 
...
- beruhen:
    ...
    - wir lassen die Sache auf sich beruhen _
...
- ausscheiden:
    ...
    - der Bewerber scheidet aus weil weil er kein Deutsch kennt

- bescheiden:
  - er ist sehr bescheidener Mensch
  - das ist aber ein beschiedener Wunsch 
  - mit geht es bescheiden 
...
- unterschiedlich:
    - unterschiedliche Ansichten über etwas haben 

- Unterschied:
    - der Unterschied
    - es ist ein Unterschied ob du es machen wirst oder nicht

- verabschieden:
    - ich wollte mich von dir verabschieden 
    - ich wollte ihn verabschieden
...
- zurate:
    - du kannst immer das Buch zurate ziehen 
    - ich werde ihn zurate ziehen

- raten:
    - er hat mir geraten das zu machen 
    - ich kann sein ALter raten

- beraten:
    - ich habe mich beraten lassen 
    - er hat dich gut beraten
...
- erraten:
    - ich habe das erraten 

- verraten:
    - soll ich dir etwas verraten 
    - meine Sprache würde mich verraten 
    - ich will nicht mein Land verraten

- geraten:
    - ich will nicht dass es in Vergessenheit geraten wird
    - wir sind in Stau geraten  

- aneinandergeraten:
    - sie geraten viel mit ihm aneinander 

- durcheinandergeraten:
    - alle meine Unterlagen sind durcheinandergeraten 
...
- Stellplatz:
    - der Stellplatz 
    - ich habe den Stellplatz gemietet
...
- abwälzen:
    - er wälzt die Schuld auf mich ab
### trösten
- trösten:
...
### Tag 
- Tagesablauf:
    - das Ziel ist Bewegungs in den Tagesablauf einzubauen 
...
- ausbessern:
    - ich muss das Dach ausbessern 

- aufbessern:
    - ich wollte mein Gehalt aufbessern  

- nachbessern:
    - ich werde es nachbessern 

- verschlimmbessern:
    - ic habe die Situation verschlimmbessert 
...
### mühen
- abmühen:
    - ich habe mich abgemüht dir das zu erklären

- bemühen:
- mühen:
    - du musst dich nicht bemühen 
    - wir müssen den Hausmeister bemühen um es reparieren zu lassen
...
- reichen:
    ...
    - würde es für dich reichen wenn ich das so machen 
    - ich reiche mit der Hand nicht an den Schrank
    - das Wasser reicht mir bis zur Schulter 

- ausreichen:
    - das Essen reicht aus 

- ausreichend:
    - wir haben ausreichende Arbeit

- einreichen:
    - ich habe die Doku schon eingereicht 

- erreichen:
    - ich will mein Ziel erreichen 
    - wenn wir uns beeilen erreichen wir unser Ziel 
    - ich bin zu Kurz ich kann die Deckel nicht erreichen 
    - unter dieser Nummer kann ich dich erreichen 

- herumreichen:
    - der Gürtel reicht um meinen Bauch nicht herum 
    - könntest du das Bild herumreichen 

- hinausreichen:
    - das reicht über etwas hinaus

- nachreichen:
    - du könntest immer das Doku nachreichen wenn du Zeit hast 

- überreichen:
    - überreich mir das Essen 

- zurückreichen:
    - die Gesichte reicht in meine Kinderheit zurück

### richten
- richten:
    - ich muss das Bild an der Wand richten
	- ich richte mich nach dir [nach]
	- ich riche mich an dich [an]
...
- aufrichten:
    - ich richte ihn im bett auf 

- ausrichten:
    - richt ihm bitte aus, dass ich hi sage
    - ich soll dir Grüss von ihm ausrichten 
    - ich richte das Mikro auf dich aus

- berichten:
    - es gibt nichts zu berichten 

- einrichten:
    - ich will die Wohnung neu einrichten 
    - ich muss die das Konto / den laptop neu einrichten
    - kannst du so einrichten dass du um 10:00 uhr das sein 
    - richt dir so ein dass du morgen früh anfangen sollst
    - ich habe mein Leben so eingerichtet dass ich mehr Freizeit haben kann [organisiert]
    - ich habe mich auf lange Wartung eingerichtet (sich) [einstellen]

- errichten:
    - Gebäude errichten [bauen]
    - Durchgang errichten

- herrichten:
    - ich habe den Raum für den Besucher hergerichtet 
    - ich richte mich her 
...
- verrichten:
    - Muslime verrichte ihre Gebetete 5 Mal am Tag

- zugrunde richten:
    - er hat die Firma zugrnde gerichtet

- zurichten:
    - wer hat dich so zugerichtet (verletzt)
    - ich habe das Holz zugrichtet [vorbereitet]
...
- abfälschen:
    - ich hat den Ball abgefälscht

### reiben
- reiben:
    - ich reibe mir die Augen 
    - ich reibe die Zweibeln

- abreiben:
    - ich reibe den Rost von dem Blech 
    - ich reibe mich ab (abtrocknen)
...
- aufreiben:
    - die Hitze reibt mich auf 

- zerreiben:
    - ich zerreibe den Käse über die Nudel
...
- abkriegen:
    - ich kriege die Farbe von den Kleidung nicht ab [abbekommen]
...
- herumkriegen:
    - ich lass mich von ihm herumkriegen 
    - ich habe meine Frau dazu herumkriegt, mir zu helfen 
    
- einkriegen:
    - kriege dich ein [beherrschen]

- fertigkriegen:
    - ich kriege es bis morgen fertig 
...
- kleinkriegen:
    - ich lass mich nicht kleinkriegen [kleinbekommen]
...
- ausleben:
    - ich wolle meinen Drang ausleben
    - man kann hier seine Gedanken ausleben 

- mitleben:
    - es ist ok ich kann mit soetwas mitleben 

- beleben:
    - das hat diese Stadt belebt

- durchleben:
    - ich habe viel in meinem Leben durchlebt 

- einleben:
    - ich brauche Zeit bis ich mich in dem Team einleben [eingewöhnen]

- erleben:
    - ich habe viel in meinem Leben erleben 
...
### rahmen 
- abrahmen:
    - hier kann man richtig absahnen 
    - ich will einkassieren 

- Rahmen:
    - der Rahmen 
    - das wird den Rahmen unseres Meethings sprengen 
...
- Freude:
    ...
    - ich lasse mir die Freude an der Arbeit nicht nehmen  
    - ich weine vor Freude 

- erfreuen:
    - ich wollte dich einfach erfreuen 
    - ich erfreue mich an meinem Urlaub

- erfreulich:
    - man kann nicht nur Erfreuliches erleben
...
- mischen:
- vermischen:
    - ich werde die Karte mischen 
    - Salz und Wasser mischen sich gut 

- beimischen:
    - ich werde dem Kuchen etwas Süßes beimischen 
    - meiner Freunde ist eine leichte Traurigkeit beigemischt 

- durchmischen:
    - Die Zutaten für den Salat sollten gut durchgemischt werden, damit das Dressing gleichmäßig verteilt ist 

- entmischen:
    - Unter bestimmten Bedingungen können sich die Komponenten einer Lösung entmischen 
...
- Nutzen:
    - der Nutzen 
    - wir ziehen viel Nutzen von dieser Sache 

- nutzen:
    - ich werde jede Minute nutzen um das zu erreichen 
    - deine Reue nutzt dir nicht viel [dativ]

- abnutzen:
    - ich habe meine Schuhe abgenutzt
    - die Schuhe nutzen sich ab 

- ausnutzen:
    - er hat mich ausgenutzt 

- benutzen: 
    - ich benutze den Laptop kaum 
...
- Anspruch:
    - der Anspruch 
    - ich habe keinen Anspruch auf das Angebot 
    - ich werde soetwas in Anspruch nehmen 
    - er stellt hohe Anspruch an mich 
    - es ist mit hohen Ansprüchen verbunden
    - es erhebt keinen Anpruch auf Vollständigkeit      

- beanspruchen:
    - das hat mich beanprucht 

- überbeanspruchen:
    - Du überbeanspruchst meine Geduld mit deinen Fragen!, die Gelenke überbeanspruchen

### schützen
- schützen:
- beschützen:
    - er schützt seinen Bruder 

- vorschützen:(vorschieben)
    - ich schützt seinen Kopfschmerzen vor um uns nicht zu helfen 
...
### schonen 
- schonen:
    - ich wollte den Akku schonen 

- verschonen:
    - ich wollte dich mit Details verschonen

- beschönigen:
    - er hat die Situation beschönigen

### ändern
- Änderung:
- Veränderung:
    - die Änderung an + dativ
    - die Veränderung an + dativ
...
- verändern:
    - er hat sich verändert [starke_Änderung]
...
- abwandeln:
    - ich habe es nur abgewandelt 

- verwandeln:
    - er hat sich verwandelt [startke_änderung]
...
- Kleid:
    ...
    - meine Kleider sind immer nicht sauber 

- ankleiden:
- auskleiden:
    - ich kann mich selbst ankleiden 

- bekleiden:
    - er ist mit Hemd bekleidet 

- einkleiden:
    - ich muss mich neu einkleiden [kleidung kaufen]
   
- verkleiden:
    - ich habe mich als Spiderman verkleidet  
...
- verkriechen:
    - der Hund hat sich in die Hütte verkrochen

- zappeln:
    - er zappelt die ganze Nacht 
    - lass ihn zappeln [lassen]
...
- krankschreiben:
    ...
    - ich habe mich für diese Woche krankschreiben lassen 

- verschreiben:
    - ich habe mich verschrieben 
    - der Artzt hat mir ein Medikament verschrieben 

- vorschreiben:
    - er schreibt uns vor was wir machen müssen

- überschreiben:
    - er hat mir das Haus überschrieben 
...
### schmieren
- schmieren:
    - ich muss das Fahrrad schmieren 
    - Sonnencreme auf den Rücken 

- abschmieren:
    - Speichere deine Daten regelmäßig! Wenn das Programm abschmiert, ist alles weg.

- beschmieren:
    - ein Brötchen mit Butter beschmieren

- zuschmieren:
    - er hat alles zugeschmiert

### streichen
- streichen:
    - du kannst meinen Name aus der Liste streichen 
    - ich muss die Wände Weiss streichen 
    - Butter auf das Brot streichen 
    - wir streichen dieses Jahr den Urlauben 
    - mein Vater hat mir das Taschengeld gestrichen 
...
- einstreichen:
    - ich habe viel Geld eingestichen 
    - die Butter auf den Kuchen einstreichen 

- herausstreichen:
    - ich habe die wichtigen Punkten herausgestrichen
...
- zusammenstreichen:
    - die Kosten werden zusammengestrichen [verringen]

- Abstrich:
    - der Abstrich 
    - wur müssen Abstriche hinnehmen 
    - der Artz hat einen Abstrich gemacht 

- Strich:
    - der Strich 
    - ich will dir keinen Strich durch die Rechnung machen
    - unter dem Strich war das Projekt erfolgreich
    - strich unter die ganze Nummer ziehen 

- Anführungsstrich:
    - einfache Anführungstriche 
    - doppelte Anführungsstiche 
...
- abstreifen:
    - er streift seine Schüchtern ab 

- herumstreifen:
    - ich streife in die Stadt herum 

### schweifen
- schweifen:
    - ich schweife in die Stadt 

- abschweifen:
    - ich scheine vom Thema abgeschweift zu sein 
    - ich will nicht vom Thema abschweifen 
    - ich habe mit den Gedanken abgeschweift 
...
- Haken:
    - der Haken 
    - wo ist der Haken 
    - ich kann das an den Haken anbringen
    - ich habe Haken dran gemacht
    
- haken:
    - mein Fahrrad hakt  
    - wo hakt es dieses Mal 
    - woran hat es gehakt
...
- einhaken:
    ...
    - wenn ich an diesem Punkt einhaken darf

- verhaken:
    - ich werde die Klette verhaken  [verfangen]
    - die Jacke verhakt sich im Türgriff 
...
- klemmen:
    - die Tür klemmt 
    - ich klemme mich hinter das Ziel 
...
- klammern:
    ...
    - ich klammere mich an die Aste

- anklammern:
    - ich klamme die Wäsche an der Leine an 
    - ich klammer meine Hoffnung an den Brief an

- ausklammern:
    - ich werde das thema aus der Besprechung ausklammern 

- einklammern:
    - ich habe das Wort eingeklammert 
...
- fest:
    - die Beziehung ist fest 
    - ich glaube fest an Gott
    - das ist wasser fest

- sattelfest:
    - in der Grammtik muss man sattelfest sein 
...
- aufkehren:
    - ich werde den Müll aufkehren

- auskehren:
    - ich kehre den Raum aus

- bekehren:
    - er hat viel leute zum Islam bekehren 

- einkehren:
    - ich werde in diesem Hotel einkehren 

- heimkehren:
    - ich kehre heim 

- umkehren:
    - ich will mich nicht auf halbem Weg umkehren 

- verkehren:
    - hier verkehren die Busse nur unter der Woche 

- verkehrt:
	- ich habe den verkehrten job gesucht
	- ich bin in den verkehrten Bus eingestiegen 
	- du hast den Pullover verkehert herum angezogen

- zurückkehren:
    - ich wollt zum Thema zurückkehren 

- Vorkehrung:
    - die Vorkehrung 
    - wir müssen Vorkehrung treffen 
...
- kehrseite:
    - die Kehrseite 
    - das ist leider die Kehrseite der Medalle 
...
- haufenweise:
    ...
    - man kann haufenweise Fisch essen 

- anhäufen:
    - die Arbeit hat sich angehäuft 
    - ich häufe viel Bücher an 
...
- abgraben:
    - wir sollen den Boden abgraben damit wir das hier ablegen können 
    - er hat mir das Wasser abgegraben 
    - Große Konzerne graben die Kleinen Firmen das Wasser ab 

- ausgraben:
    - ich wollte nicht die alten Erinnerungen ausgraben 

- begraben:
    - ich habe die Höffnung begraben 

- vergraben:
    - ich habe das Geld vergraben 
    - ich habe mich in die Arbeit vergraben 

- umgraben:
    - wir graben den Boden um 

- untergraben:
    - die Lügen hat das Vertrauen untergraben 

- eingraben:
    - ich grabe die Wurzel in den Boden ein

- Grube:
    - die Grube 
    - das ist eine riesige Grube 
...
- vornherein:
    - das muss man von vornherein planen 

- innerlich:
- Außerlich:
    - diese Fragt hat mich innerlich aufgefressen 
    - Äußerlich sieht alles gut aus, aber Innerlich frisst mich diese Frage auf 

- außer:
    - wir gehen schwimmen außer es regnet 
...
- buchstabieren:
    - ich werde meinen Namen Buchstabieren

- Wort:
    - das Wort 
    - ich kann dieses Wort nicht 
...
- Jahresurlaub:
    - der Jahresurlaub 
    - ich will nicht meinen Jahresurlaub am Stück nehmen 
    - ich muss meinen Jahresurlaub planen 
    - ich wollte nicht meinen Jahresurlaub aufbrauchen 

- Werktag:
    - der Werktag 
    - du hast einen Jahresurlaub von 30 Werktagen 
...
- Urlaubstag:
    - der Urlaubstag 
    - ich wollte einen Urlaubstag nehmen 

- Wochenende:
    - das Wochenende 
    - übers Wochenende / am Wochenende
    - ich wünsche dir schönes Wochenende
    - das ist ein langes Wochenende 
    - ich mache das übers Wochenende / am Wochenende

- Feierabend:
    - der Feierabend 
    - ich wollte eigentlich Feierabend machen 
    - ich verabschiede mich in den Feierabend 
    - ich werde es nach Feierabend machen

- Urlaub:
    - der Urlaub 
    - ich gehen / fahre in den Urlaub 
    - ich bin im Urlaub 
    - ich mache/nehme Urlaub
    - das fühlt sich an wie Urlaub
    - das mache ich wenn ich aus dem Urlaub zurückkomme

- ferienhaus:
    - das Ferienhaus 
    - ich mache den Urlaub im Ferienhaus

- Geburtstag:
    - der Geburtstag 
    - an meinem Geburtstag fahre ich nach Hamburg

- Ferien:
    - die Feiern
    - sie haben dort Feiern 
...
- abtöten:
- auslöschen:
    - ich will den Fehler ausmerzen 

- Tod:
    - der Tod 
    - ich habe den Tod meines Vaters nicht verkraftet 

### löschen 
- löschen:
    - ich werde diesen Teil erlöschen 
...
### breiten 
- breiten:
    - ich werde eine Decke über ihn breiten 
...
- verbreiten:    
    - es hat sich sehr schnell verbreitet 
...
- decken:
    - ich decke mein Auto 
    - das deckt den Schaden / den Bedarf nicht 
    - ich werde den Tisch decken [Geschirr_auf_den_tisch_legen]
...
- abdecken:
    ...
    - die Verletzung soll abgedeckt werden
...
- andrehen:
    - ich hat mir das Produkt angedreht 
...
- hochschrauben:
- runterschrauben:
    - Der Händler hat die Preise für Obst und Gemüse hochgeschraubt.

### schärfen
- schärfen:
    - ich will das schärfen

- einschärfen:_
    - ich habe meinem Kind im Straßenverkehrt eingeschärft 

- entschärfen:
    - ich wollt die Situation entschärfen 
...
- ummittelbar:
    - der Weg führt unmittelbar zum Zoo
    - er ist mein unmittelbar vorgesetzter

- Mittelweg:
    - der Mittelweg [Kompromis]
    - wir müssen einen Kompromiss gehen
...
- wegtrainieren:
    ...
    - ich habe mir Rauchen abtrainiert 

- antrainieren:
    - ich habe mir Flexibiltät antrainiert 
...
- ausüben:
    - er übt Druck auf mich aus 

- einüben:
    - ich muss diese Bewegung einüben 
...
- aufbieten:_
    - ich muss meine Kraft aufbieten 
...
- unterbieten:
    - die Hotels unterbieten sich gegenseitig 
...
- bitten:
    - gebeten 
    - ich habe um einen Kaffe gebeten 
    - ich bitte dich zum Kaffe 

- erbitten: (bitten um)
    - ich erbitte deine Hilfe 

- ausbitten:
    - darf ich mir ausbitten dass sie meine Privatsphäre respektieren
...
- Abbitte:
    - die Abbitte 
    - ich haben einen Fehler gemacht aber ich werde nicht hingehen und Abbitte leisten 
...
- anbeten:
    - in der Mosche betet man Gott an     

- nachbeten:
    - ich habe keine Meinung ich bete nach was er mir gasgt hat (nachreden) 

- Bett:
    - das Bett
    - ich bringe dir das ans Bett
...
- Freiraum:
    - der Freiraum 
    - ich habe viel Freiraum zu machen was ich will 

- freie Bahn:
    - ich habe den Stau überfahren wir haben jetzt freie Bahn 
...
- freiheit:
    - die Freiheit
    - du hast du Freiheit zu tun was du willst 

- Zweifelsfrei:
    - ich kann das nicht Zweifelsfrei sagen 
...
- aushebeln:
    - Hacker haben die Sicherheitsvorkehrungen der Bank ausgehebelt.
...
- ordnen:
    ...
    - ich ordne es nach schwerigkeit 

- abordnen:
    - sie haben mich zu diesem Standtort abgeordnet 
...
- verordnen:
    - der Artz hat mir das Medikament verordnet 

- zuordnen:
    - ich glaube man hat mich der falsche Gruppe zugeordnet [zuteilen] 
...
- neuordnen:
    - ich muss meine Gedanken neuordnen 
    - ich habe die Möbel neugeordnet
...
- vergewissern:
    - ich wollte mich vergewissern dass ich die Tür zugemacht habe
...
- bestärken:
    - meine Eltern bestärken mich in meinem Vorhaben 
...
- Feingefühl:
    - das Feingefühl 
    - er verfügt nicht über Feingefühl
...
- stören:
    ...
    - was stört mich an ihm ist das 
    - ich will dich bei der Arbeit nicht stören

- aufstören:
    - er hat mich beim Schlafen aufstören 

- entstören:
    - ich werde den Fehler entstören 
...
- abfärben:
    ...
    - das schlechte Benehmen färbt auf meinen Sohn ab 
...
- bröckeln:
    - das wird bröckeln 
    - ich muss das Brot bröckeln 

- bröckelig:
    - die Wand ist bröckelig

- abbröckeln:
    - der Putz bröckelt von der Wand ab 
...
- kauen:
    ...
    - ich habe an diesem Problem zu kauen 

- abkauen:
    - ich kaue die Nägel ab 

- durchkauen:
    - ich kaue es durch 

- vorkauen:
    - ich muss ihm alles vorher vorkauen 
...
- Sieb:
    - das Sieb 
    - ich werde die Nudeln in ein Sieb geießen 
...
- zerhacken:
    - ich habe es zerhackt [zerdrücken] 
...
- abpumpen
- auspumpen:
    - Wasser aus dem Keller abpumpen 

- aufpumpen:
    - ich pumpe den Reifen auf 

- anpumpen:
    - er hat mich wieder um Geld angepumpt [anhauen]
...
### schleichen 
- schleichen:
    - sie schleicht ins Zimmer 

- schleichend:
    - schleichender verlauf

- beschleichen:
    - mich beschleicht die Angst dass ihm etwas schlimm passiert 
...
### pendeln 
- pendeln:
    - ich muss jeden Tag zwischen Hamburg ums Hannover pendeln 
...
- Sturz:
    - der Sturz 
    - ich habe mich beim Sturz verletzt 
...
### wett    
- wetten:   
    - ich wette dass er nicht kommen wird
...
- ereignen:
    - es hat sich viel in kürzer Zeit ereignet 

- aneignen:
    - ich muss mir die Knowhow erst aneignen
...
### klappen 
- klappen:
    - wenn alles klappt, können wir morgen fertig sein 

- aufklappen:
- zuklappen:
    - kann man aufklappen wenn es nottut 
...
- beglückwünschen:
    - ich habe ihn zu seinem Erfolg beglückwünscht 

- verwünschen:
    - ich verwünsche den Tag an dem ich sie getroffen habe 

- wegwünschen:
    - ich wünsche ihn weg 
    - ich kann nicht einfach die Probleme wegwünschen

- zurückwünschen:
    - ich wünsche ihn zurück 

- Wunsch:
    - der Wunsch
    - Auf Wunsch kann ich das machen
    - hast du noch einen Wunsch
    - ich habe den Wunsch nach Essen
    - ich bin auf deinen Wunsch eingegangen 
...
- Wissen:
    - das Wissen 
    - das ist ohne mein Wissen passiert 
    - im Wissen dass wir das nicht entschädigen können
...
- Gewissen:
    - das Gewissen
    - ich habe schlechtes Gewissen wenn ich das nicht machen werde
...
- gewisse:
    ...
    - ein gewisser Grad an Vorsicht ist hier Ratsam

- wissentlich:
    - er hat das wissentlich gemacht 
...
### genüng 
- genügen:
    - genügt dir eine Stunde um das zu machen 

- genügend:
    - ist genügned Kaffee da 
...
- vergnügen:
    - ich vergnüge mich mit der Arbeit 
...
- entsinnen:
    ...
    - ich muss mich auf meine Starke besinnen

### baden
- baden:
    - ich will das Kind baden
...
- Bad:
    - das Bad
    - ich nehme schnell ein Bad 

### deuten 
- deuten:
    - er deutet auf ihn 
    - Hohe Kosten deuten manchmal auf ein Problem 
    - ich kann seine Aussage nicht deuten
...
- Bedeutung:
    - die Bedeutung 
    - er hat mehr als eine Bedeutung 
    - es verliert viel an Bedeutung

- hindeuten:
    - das deutet auf einen Fehler hin 

- missdeuten:
    - er hat meine Aussage missgedeutet 
...
- schwindeln:
    - ich habe beim Alter geschwindelt
...
- hemmen:
    ...
    - das hemmt mich in meiner Entwicklung

- gehemmt:
    - ich bin ein bisschen gehemmt 

- Hemmung:
    - die Hemmung 
    - er hat keine Hemmungen mehr 
...
- hungern:
    - man wird nicht hungern

- abhungern:
    - ich habe mir 3 Kilo abgehungert

- aushungern:
    - sie hungern die Leute aus 
    - ich bin ausgehungert [nicht sterben]

- verhungern:
    - sie verhungern die Leute [sterben]

### traum 
- Traum:
    - der Traum 
    - das war mein Traum nach Amerika zu fliegen 
...
- bereichern:
    ...
    - das Gespräch hat mich bereichtert 

### eigen
- eigen:
    - ich habe schon ein eigenes Auto 
    - das kannst du mit deinem eigenen Geld kaufen
    - ich habe eine eigene Meinung gebildet 

- eigenleistung:
    - das wird als eigenleistung betrachtet 

- eigensinnig:
    - er ist sehr eingensinnig 

- eigenartig:
    - das ist aber eigenartig von dir 

- eigenmächtig:
    - das kann ich nicht eigenmächtig ändern 

- Besitzer:
- Eigentümer:
    - er ist der Besitzer / Eingentümer 

- eigenheim:
    - das Eigenheim 
    - ich kann mir Eigenheim nicht leisten
...
### irren
 beirren:
    - lass dich durch ihn nicht beirren 

- irren:
    - ich habe mich in der Addresse geirrt.
...
- Irrtum:
    ...
    - ich habe ihn über sein Irrtum aufgeklärt 
...
- tropfen:
    ...
    - ich tropfe wasser auf den Grass
...
- schwanken:
    - ich schwnake zwischen  A und B 
    - die Temperatur schwankt um niedrige Temperature 

- aufbauschen:
    - ich will nicht jede kleinigkeit aufbauschen 
    - es war kleinigkeit aber weil wir darüber nicht gesprochen haben, hat es sich aufgebauscht
...
- berechtigen:
    - das berechtige dich zum Teilnehmen an dem Kurs
...
- gerecht:
    ...
    - er war den Verantwortungen gerecht
...
- Schicht:
    - die Schicht
    - es gibt eine dünne Schicht Öl 
    - er hat heute Spät Schicht

- vielschichtig:
    - das ist aber ein vielschichtiges Thema [Komplex]
...
- stapeln:
    - ich stapeln Holz 
    - der Arbeit stapelt sich  

- aufstapeln:
    - ich stapel die Büchter auf 
...
### bedingt
- bedingen:
    - harte Arbeit bedingt nicht immer Erfolg 
    - Vertrauen und Kommunikation bedingen sich gegenseitig 

- ausbedingen:
    - ich habe mir ausbedungen dass ich vin zu Haus arbeiten kann 

- unbedingt:
    - das musst du unbedingt schauen 

- saisonbedingt:
    - das ist aber Saisonbedingt 

- Bedingung:
    - die Bedingung 
    - die Bedingung für die Arbeit war sehr ungünstig 
    - unte einer Bedingung 

- Ding:
    - das Ding 
    - für die Reparatur fehlt noch ein Paar dinge 

### Zweig
- Zweig:
    - der Zweig 
    - ich komme nicht auf grünen Zweig

- abzweigen:
    - der Master zweigt von hier ab 
...
- Mitternacht:
    - die Mitternach 
    - um die Mitternacht fährt der letzte Zug

- übernachten:
    - wir können im Hotel übernachten 
...
- endgültig:
    - meine Entscheidung ist endgülig 
...
- abgekämpft:
    - ich bin abgekämpft 
    - ich habe mich mit dieser Aufgabe abgekämpft 

- ankämpfen:
    - ich kämpfe gegen den Drang aufzugeben an 
...
- umkämpfen:
    - das ist hart umkämpfter Markt
    - Der Markt für Smartphones ist extrem umkämpft.
...
- ausprobieren: 
    - ich probiere das neue Gerät aus 
    - wir können diese neue Methode ausprobieren 

- aufprobieren:
    - ich probiere die Brille auf
...
- vergraulen:
    - das könnte ihn näturlich vergraulen
...
- verkaufen:
    - ich will es an dich verkaufen [an]
...
- Schweinehund:
    - der Schweinehund
    - ich muss erste den Schweinehund überwinden
...
- missgönnen:
    - ich missgönne dir diesen Erfolg nicht
...
- wahrhaftig:
    - sie haben das gesagtr aber sie haben das nicht wahrhaftig gemeint 
...
- erdulden:
    - ich kann das nicht mehr erdulden 
...
- Aufstieg:
    - der Aufstieg 
    - man hat dort bessere Chancen zum Aufstieg 
...
- übersteigen:
    - das übersteigt meinen Verstanden [überschreiten] 
...
- hineinsteigern:
    - er steigert sich in seine Wut hinein [hineinfressen]

### senken 
- senken: gesenkt
    - das sollte die Temperaure senken 
...
- einsinken:
    - ich bin in einen Schlamm eingesunken 

- versinken:
    - er ist ein einer Depression versunken
...
- abwiegen:
    - ich werde 2 Kilo Äpfel abwiegen
...
- abwägen:
    ...
    - ich wäge jedes Wort ab bevor ich mich äußer 

- erwähnen:
    - ich habe das vorher erwähmt
...
- ausmustern:
    - die Alte Geräte müssen ausgemustert werden
...
- andichten:
    ...
    - er dichtet mir Sache die ich nicht gemacht habe 
...
- beliebig:
    - du kannst einn beliebigen Wert von 1 bis 100
...
- prüfen:
- überprüfen:
    - ich werde es auf Rechtlinie prüfen 
...
- verblassen
    - die Erinnerungen verblassen allmählich

### bleich 
- bleich:
    - er ist bleich geworden 

- bleichen:
    - das bleicht die Zähne 

- ausbleichen:
    - die Kleidung ist ausgebliecht 
...
- Abweg:
    - der Abweg 
    - schlechts Umfeld führt man auf Abwege

- Umweg:
    - der Umweg 
    - auf der Fahrt nach Hamburg machen wir einen Umweg über die Stadt um Essen abzuholen 
    - das habe ich auf Umwegen erfahren 
...
### artig 
- einzigartig:
    - der String soll einzigartig sein
    - die Zahlen sollen einzigartig sein 
...
- ausgelaugt:
    - ich bin ausgelaugt [geschlaucht]
...
### bügeln
- bügeln:
    - ich will meine Kleidung bügeln 

- ausbügeln
    - ich konnte meinen Fehler wiede ausbügeln 
...
- würdig:
    - er ist der Job würdig 

- entwürdigen:
    - ich will niemanden entwürdigen 

- Merkwürdig:
- kritikwürdig:
- fragwürdig:
	- diese Entscheidung ist fragwürdig 
    - das ist merkwürdig 
...
- ummünzen:
    - die Niederlage in einen Ergolg ummünzen 
...
- auf Kosten:
    ...
    - ich kann nicht die Kosten abdecken 

- kosten:
    - das kostet mich ein Vermögen 
    - das kostet nur einen Anruf 

- auskosten:
    - ich koste meinen Erfolg aus 

- verkosten:
    - kann ich das Essen verkosten 
...
### schmelzen 
- schmelzen:
    - bei dieser Temperatur wird die schnee schmelzen 
...
### durch 
- durcharbeiten:
    - ich arbeite heute die Nacht durch 
    - ich habe mich durch diese komplexe Aufgabe durchgearbeitet (sich) 

- durchbeißen:
    - ich beiße mich durch die Aufgabe durch 

- durchboxen:
    - ich habe mich bis oben durchgeboxt 

- durchbrechen:
    - ich breche den Holz durch 
    - das Auto durchbrecht die Absperrung 

- durchbringen:
    - die Mutter soll alleine die Kinder durchbringen

- durcheinanderbringen:
    - Du darfst die beiden Sachen nicht durcheinanderbringen.
...
- durchdringen:
    - das Wasser dringt durch das Dach durch 
    - das Gefühl durchdringt mich
...
- zuneigen:
    - ich neige mehr deiner Meinung zu 
...
- abstrahlen:
    - die Sonne strahlt Hitze ab 

- anstrahlen:
    - ich werde das Gebaude anstrahlen [beleuchten]

- ausstrahlen:
    - sie strahlt mir Ruhe aus  

- bestrahlen:
    - ich lasse mich von der Sonne bestrahlt 
...
### offen 
- hoffen:   
    - ich hoffe dass es funktioneren wird 
    - ich hoffe auf baldiges Wiedersehen 

- erhoffen:
    - ich habe mir viel von ihm erhofft 
...
- offenbleiben:
    - es bleibt offen ob wir das schaffen können 

- offenhalten:
    - ich wollte mir den Ausweg offenhalten 

- offenlassen:
    - wir habe das offengelassen ob wir den Urlaub nehmen werden

- offenstehen:
    - dir stehen all Möglichkeiten offen 
    - es steht dir offen ob du mit uns fahren möchtest oder hier bleiben willst 
...
- Öffnung:
    - die Öffnung 
    - durch die Öffnung kommt das Licht 

- öffnen:
    - die Geschäfte öffnen um 8 Uhr 
    - ich habe die Tür geöffnet 
    - die Tür öffnet sich durch den Wind 
    - zum Öffnen benutzt du das Messer 
...
- zufriedenstellen: 
    - es ist nicht meine Aufgabe ihm zufriendenzustellen 

- zufriedengeben:   
    - wir müssen uns nicht schnell zufrieden geben 

### zucken
- zucken:
    - meine Hand zuckt vor Kälte 
...
- Rucksack:
    - der Rucksack 
    - er trägt seinen Rücksack mit sich herum 

- absacken:
    - lass die Knie nicht absacken  

- einsacken:
    - ich sacke Kartofel ein [einpacken]
...
- zusammensacken:
    - das Projekt sackt zusammen weil kein Geld vorhanden ist [zusammenbrechen] 

- wegsacken:
    - mein Kopf ist weggesackt
...
- vermieten:
    - ich vermiete nur an nichtraucher [an]

- untermieten:
- untervermieten:
    - ich habe ein Zimmer untervermietet

### eben 
- eben:
    - das land hier ist eben 
    - er kommt eben 
    - deswegen hast du das gemacht ? eben 

- ebenfalls:
    - viel Glück. ebenfalls (gleichfalls, ebenso) 
...
- Frist:
    - die Frist
    - ich halte mich an die Frist
    - ich werden die Frist einhalten
...
### form
- formen:
    - die Erfärhung hat mich zu dieser Person geformt 

- umformen:
    - ich werde alles umformen 

- verformen:    
    - die Hitze hat es verformt 

- armförmig:
    - es ist armförmig 

- anformen:
    - das Kissen formt sich dem Kopf an

- V förmig:
    - es ist ein V förmiger Griff 

- Form:
    - die Form 
    - ich werde es in verständlichere Form bringen 

- formulieren:
    - wie kann ich das richtig formulieren 
    - das war nicht richtig formuliert 

- ausformulieren:
    - ich werde es näturlich ausformulieren 
...
- Format:
    - das Format 
    - in welchem Format die Informationen abgespeichert werden müssen 
...
- verpflichten:
    - du bist nicht zur Teilnahme verpflichtet
    - Das offen der Verpackung verpflichtet zum Einfkauf
    - das verpflichten dich zum Einkauf 

- beipflichten:
    - ich muss dir beipflichten dass er Recht hat 

### wicht
- Gewicht:
    - das Gewicht
    - jemand, der ein normales Gewicht hat, kann das einfach machen  
    - das fällt kaum ins Gewicht (es ist unwichtig)
    - ich verliere gleich Gewicht 
...
### verlangen
- verlangen:
    - das verlangt mehr Geduld von dir

- Verlangen:
    - das Verlangen 
    - ich kann das auf Verlangen machen 

- abverlangen:
    - das verlangt dir viel Geduld ab 
...
- Begier:
    - die Begier 
    - vor Begier brennen [Verlangen]

- neugierig:
    - ich bin darauf neugierig wie hast du es geschafft 
...
- Schritt:
    - der Schritt 
    - das ist sehr wichtiger Schritt für uns 
    - wir haben diesen Schritt ausgelassen
...
- einschreiten:
    - die Polizei hat gegen die Demo eingeschritten [eingreifen] [durchgreifen]
...
### hüten 
- hüten:
    - ich muss mich vor Dieb hüten
    - ich muss die Kinder hüten [beaufsichtigen]

- verhüten:
    - wir haben das schlimmste verhütet 
...
- abblitzen:
    - du kannst ihn fragen, du wirst beim ihm abblitzen 
...
- auswählen:
    - ich habe schon ausgewählt 

- verwählen:
    - ich habe mich verwählt [telefon]

- vorwählen:
    - du musst 10 worwählen 
...
- Auswahl:
    - die Auswahl 
    - sehr viele Auswahl an Produkte 
...
### tipp 
- eintippen:
    - ich muss das eintippen 

- tippen:   
    - ich bin am tippen 

- vertippen:
    - ich habe mich bei dem Wort "Ahmed" vertippt 
...
### kleben
- kleben:
    - ich werde die Vase kleben 

- klebrig:
    - ich habe klebrige Finger

- abkleben:
    - ich muss die Ränder abkleben 

- ankleben:
- aufkleben:
    - ich klebe das Bild an die Wand an
...
- Zielsetzung:  
    - die Zielsetzung 
    - wir haben diese Zielsetzung verfolgen 

- Ziel:
    - das Ziel 
    - ich will dem Ziel nachgehen 
    - ziel verfolgen 
    - ich habe das Ziel verfehlt 

- abzielen:
    - ich hoffe du weisst genau, woaruf ich abzielen will
    - das sind die wichitge Aspekten, auf die wir abzielen wollen 
...
- Fehler:
    ...
    - ich will den Fehler korrigieren 
    - der Fehler hat sich durch den Code durchgezogen 
    - der Fehler ist mir unterlaufen 
...
- Fehlverhalten:
    - das Fehlerverhalten
    - ich bereue mein Fehlverhalten 

- Fehlurteil:
    - das Fehlurtril 
    - das war ein Fehlurteil meiner Seite 
...
- Leid:
    ...
    - ich habe viel Leid erlebt 

- leiden:
    - ich kann ihn nicht leiden 
    - er leidet an Krankheit 
    - er leidet unter der Verlust 

- erleiden:
    - er hat viel schlimmes erlitten 
...
- Vergeltung:
    - die Vergeltung 
    - er wollte Vergeltung üben 

- Entgelt:
    - das Entgelt 
    - das kann man benutzen gegen ein kleines Entgelt 
    - das reicht mir als Entgelt 
...
### streng
- anstrengen:
    - ich muss mich anstrengen damit ich das erreichen kann [dahinterklemmen]

- Anstrengung 
    - die Anstrengung:
    - das ist mit großen Anstrengungen verbunden 
...
- qualifizieren:
    - das qualifiziert dich für diese Aufgabe 
...
### lohn 
- lohnen:
    - es löhnt sich, einen Versuch zu machen  
    - es hat sich nicht gelöhnt

- Lohn:
    - der Lohn 
    - ich habe keinen Lohn erwartet 
    - das ist der Lohn für meine Hilfe 

- belohnen:
    - er hat mich für meine Arbeit belohnt 
...
- Fahndung:
    - die Fahndung 
    - die Fahndung nach dem Hund 

- Fahne:
    - die Fahne 
    - sie haben eine Frau wegen einer Fahne gejagt 

- ahnen:
    - das habe ich geahnt [spüren]
    - ich ahnte dass etwas nicht stimmt 
    - das habe ich imme geahnt 
...
- vorausahnen:
- erahnen:
    - das konnte ich nicht vorausahnen 
...
- mahnen:
    - ich wollte dich daran mahnen dass du das machen mussen 

- abmahnen:
    - der Arbeitgeber hat mich abgemahnt 

- Abmahnung:
    - die Abmahnung 
    - nach der Abmahnung kann Kündingung erfolgen 

- ermahnen:
    - der Chef hat mich ermahnt 
...
- Kommando:
    - das Kommando 
    - er hat auf mein Kommando nicht reagiert 

- kommandieren:
    - er kommandiere gerne 

- abkommandieren:
    - er hat mich zu ihm abgekommandiert 
...
- anheizen:
- aufheizen:
    - das wird die Stimmung angeheizt 
...
- verfaulen:
    - das essen wird varfaulen 

- aktiv:
    - er ist sehr aktiver Mensch 

- proaktiv:
    - er hat proaktiv gehandelt 

- reaktiv:
    - er verhält sich sehr reaktiv
...
- abschirmen:
    - ich wollte ihn gegen etwas abschirmen 
    - das Licht abschirmen 

- beschirmen:
    - ich wollte ihn beschirmen 
    - mein augen beschirmen 

### außen
- außen vor:
    - wir lassen das Thema außen vor [ignorieren]
...
- losdürfen:
    - wir dürfen jetzt los 
    - ich warte bis der Regen nachlässt, dann dürfen wir los 

- losgehen:
    - das Meeting geht in einer Stunde los [anfangen] 

- losfahren:
    - der Zug fährt um 2:00 Uhr los 

- losbinden:
    - ich werde das Boot losbinden
    
- loskriegen:
    - ich kriege es nicht los 

- loslassen:
    - ich lasse alles los und fange neu an 
    - um glücklich zu sein muss man einfach loslassen 

- loslaufen:
    - ich kann das Rennen nicht gewinnen wenn ich nicht loslaufe 

- loslegen:
    - ich lege los
    - ich werde morgen mit der Arbeit loslegen 

- lossagen:
    - er hat sich vom Glauben losgesagt [abkehren] [abschwören]

- loswerden:
    - ich werde das Gefühl nicht los 
    - du wirst diese Aufgabe nicht los 
...
- Sphäre:
    - die Sphäre 
    - das ist ein Eingriff in die Privatsphäre der Leute

- Privatsphäre:
    - die Privatsphäre 
    - ich will dass du meine Privatsphöre respektieren 

- Einflusssphäre:
    - die Einflusssphäre
    - sie steht unter der Einflusssphäre der EU 
...
- Konto:
    - das Konto
    - ich habe nicht viel Geld auf dem Konto
    - ich kann sicherlich vom Konto überweisen 
    - ich will ein Konto eröffnen 
...
- konfrontieren:
    - ich habe ihn mit der Wahrheit konfrontiert 
...
- Anreiz:
    ...
    - der Auftrieb 
    - die Motivation
    - das gibt mir den Auftrieb das zu machen 

- motivieren:
    - ich habe ihn motiviert das zu machen 

- motiviert:
    - das Problem war, dass er nicht motiviert geblieben ist 

- Motto:
    - das Motto 
    - ich mache es nach dem Motto 

### exist
- existieren:
    - das existiert in dieser Form nicht mehr 
...
- Respekt:
    - der Respekt
    - ich habe keinen Respekt vor seinem Verhalten
    - man muss die Älteren mit Respekt behandeln 
...
- schrappel:
    - der Schrappel 
    - wenn es nicht geklappt hat, hört man einen schrappel
...
### Feld 
- Umfeld:
    - das Umfeld ist mir sehr wichtig 
...
- schräg:
    - die Wand ist schräg 
    - sie ist eine schräge familie 
    - ich fande es sehr schräg 

- kömisch:
    - ich fande es sehr kömisch 

### rein
- rein:
    - er hat eine reine Seele 
    - ich wollte reinen Tisch machen deswegen gebe ich zu dass ich einen Fehler gemacht habe 

- reinigen:
    - ich will meine Kleidung reinigen 

- bereinigen:
    - ich wollte das Missverständnis bereinigen 

- einigen:
    - wir haben uns auf einen Termin geeinigt 

- einig:
    - wir sind in diesem Punkt einig 
	- es ist gut dass wir über solche Punkte einig sind
...
- einerseits:
    - einerseits möchte ich gerne dort wöhnen andererseits/anderseits kann ich mir das nicht leisten

- meinerseits:
    - ich habe meinerseits nichts dagegen 
...
- allein:   
    ...
    - ich muss das allein entscheiden

- alleinerziehend:
    - sie ist alleinerziehende Frau 

- Alleinsein:
    - das Alleinsein 
    - ich habe Angst vor Alleinsein 
...
- allenfalls:
- bestenfalls:
    - ich werde das allenfalls einmal pro Woche 

- allerlei:
    - Es ist wirklich interessant, ich habe allerlei solche Erfahrungen.

- allesamt:
    - wir haben viele Projekts allesamt passen nicht zur mir 
...
- vergiften:
    - das hat die Beziehung vergiftet 

- entgiften:
    - das Kann den Boden entgiften 
...
- abtasten:
    - die Polizei hat ihn nach Waffer abgetastet 

- antasten:
    - niemand darf das Recht der Leute antasten 

- unantastbar:
    - das ist unantastbare Sache 

- herantasten:
    - das Kind taste sich an ihn heran 
...
- spontan:
    - wir haben es spontant entschieden 
...
- basieren:
    - das basiert auf falschen Annahmen 

### koppeln
- koppeln:
    - die Gehalteserhöhung ist an die Leistung gekoppelt

- entkoppeln:
    - wir müssen das entkoppeln 

- Rückkopplung:
    - die Rückkopplung 
    - das ist eine postive Rückkopplung 

### fakt &&& tor
- Faktor:
    - der Faktor 
    - das ist sehr wichtiger Faktor 
...
- Torheit:
    - die Torheit 
    - ich will keine Torheit begehen
...
- Fakt:
    - der Fakt
    - Fakt ist dass ich das keine Zeit dafür habe
...
### Klusive
- inklusive:
    - es kostet 10 Euro mehrsteuer inklusive 
    - was ist dir wichtig er oder die Familie inklusive mir 

- exklusive:    
    - das kostet 20 euro Exklusive dem Frühstuck

### kotzen 
- kotzen:
    - ich könnte kotzen wenn ich das anhöre
    - das war zum Kotzen 

- ankotzen:
    - es kotzt mich an dass ich das machen muss 

- auskotzen:
    - er hat sich über seine Angst ausgekotzt 

- vollkotzen:
    - er hat das Auto vollgekotzt 
...
### produktiv 
- produktiv:
    - das war sehr produktives Gesprächig 
...
- Auskunft:
    - die Auskunft
    - er hat darüber keine Auskunft gemacht 

- Herkunft:
    - die Herkunft
    - er hat eine Immgratione Herkunft 
...
- Unterkunft:
    - die Unterkunft 
    - die Unterkunft wird frei zur Verfügung gestellt 
...
- gelingen:
    ...
    - es ist mir gelungen , ihn zu überreden mit uns zu kommen 

- missgelingen:
    - es ist mir missgelungen das zu schaffen 

### zwischen 
- zwischendurch:
    - ich mache zwischendurch Pause 
...
- Bequemlichkeit:
    - die Bequemlichkeit
    - die Bequemlichkeit ist ihm sehr wichtig 
    - er hat das einfach aus Bequemlichkeit nicht gemacht 
...
- minimal:
    - sie unterschieden sich minimal 

- minimalistisch:
    - er ist minimalistische Person

- minimieren:
- maximieren:
    - wir wollen den Gewinn zu maximieren 

### kacken 
- kacken:
    - der Hund hat hier gekackt 
...
- abkacken:
    - er hat bei dem Siel abgekackt 

- verkacken:
    - er hat die Prüfung verkackt 
...
- Rausch:   
    - der Rausch 
    - ich habe im Rausch der Liebe das nicht gesehen 

- berauschen:
    - der Erfolg hat mich berauscht
...
### zugrunde
- zugrunde liegend:
    - das zugrunde liegend Prinzip ist fairness
    - das zugrunde liegende Problem ist dass ich keine Zeit habe

- zugrunde liegen:
    - dem Erfolg liegt viele Arbeit zugrunde 
    - der Entwicklung liegt viele Faktoren zugrunde 
...
- schlechtmachen:
    - sie hat mich bei dem Chef schlechtgemacht 

- schlechtreden: 
    - ich will deinen Erfolg nicht schlechtreden  

- verschlechtern:
    - das hat die Situation verschlechtert 

- Geschlecht:
    - das Geschlecht  
    - welches Geschlecht ist dein Kind 

### grup
- gruppieren:
    - ich werde die Tickte gruppieren 

- eingruppieren:
    - die Tickte nach dem Thema eingruppieren 
...
- Deutschland:
    - ich wohne im Deutschland 

### ide 
- ideal:
    - sie wählt die ideale Route 
...
- identifizieren:
    - ich konnte den Fehler identifizieren 
    - ich habe mich mit diesem Ziel identifiziert da ich es gut finde 
...
### stat
- statt:
    - ich frage dich statt meinen Vater 
    - statt meines Autos nehmen ich heute das Taxi 

- statt dass:
    - statt dass er mir hilft, sitzt er vor dem Fernseher 

- stattdessen:
    - ich mache heute nicht das Essen stattdessen bleibe ich zuhause 

- station:
    - die Station 
    - die nächste Station 
    - an der nächsten Stätion umsteigen 

- status:
    - der Status 
    - das ist mit hohen Status
...
- einzeln:
    ...
    - einzeln verpacken 
    - einzelnes Auto 
    - jeder einzelne seite 
    - im einzelnen

- Einzelheit:
    - die Einzelheit 
    - in allen Einzelheiten erzählen 
...
- wöchtenlich:
    - das ist ein wöchentliches Treffen 

- zweiwöchig:
- dreiwöchig:
    - das ist ein dreiwöchiger Kurs
...
- fesseln:
    ...
    - das hat uns gefesselt 

- entfesseln:
    - du hast ihn entfesselt 
...
- Adressant:
- Adressat:
    - der Adressant- den Adressanten [sender]
    - derAdressat [empfänger] 
...
- Alter:
    ...
    - im Alter wird man schwächer 

- altern:   
    - die Haut altert früh 

- veralten:
    - die list ist leider veraltet 

### Kommentar
- Kommentar:
    - der Kommentar
    - der Kommentar war sehr klar 
...
- auskommentieren:
- einkommentieren:
    - auskommentieren -> rauskommentieren 
    - einkommentieren -> reinkodieren
...
- Spaß:
    - de Spaß 
    - ich habe keinen Spaß an der Arbeit
...
- kommunikativ:
    - er ist sehr kommunkativ 

- kommunizieren:
    - ich habe mit ihm kommuniziert 
...
- thematiseren:
    - ich will das nicht thematiseren

### jung
- jung:
    - er ist sehr jung 
    - sie hat ein junges Gesicht 
...
- warnen:
    ...
    - ich warne dich vor einer Gefahr
...
- ermöglichen:
    - das ermöglicht dir die Ausbildung
...
- abpflücken:
    - Blumen von Bäume abpflücken 

- zerpflücken:
    - er hat meine Argumentation zerpflückt 

### Zeit 
- Zeit:
    - zu gegebener Zeit
    - ich kann keinen festen Zeitpunkt nennen 
    - ich werde mir Zeit nehmen um diese Aufgabe zu machen
    - verbleibende Zeit ist nicht genung 
    - die gebruachte Zeit 
    - die benötige  Zeit
    - Zeit gerissen 
...
- ehrgeizig:
    - er ist sehr ehrgeiziger Mensch 

- Ambition:
    - die Ambition 
    - er hat Ambition auf diese Stelle 
...
- einheiraten:
    - willst du in diese Familie einheiraten 
...
- weit:
    ...
    - ich bin so weit dass ich das machen kann [so weit] 
    - weites Feld 
    - wie weit ist von hier bis

- weit weg:
    - er ist weit weg von hier 

- inwieweit:
    - inwieweit muss ich das machen 

- weltweit:
    - weltweit kann man das machen 

- weiterkommen:
    - wir sind mit der Arbeit weitergekommen

- weitgehen:
    - du bist so weit gegangen 

- weit geöffnet:
    - die Tür soll weit geöffnet sein 

- Reichweite:
    - die Reichweite 
    - das Auto hat Reichweite von 900 KM mit einer Tankfüllung
...
- wohlbefinden:
    - das Wohlbefinden 
    - das ist gut für das Wohlbefinden
...
- kollaborieren:
    - es gibt immer neue Wege zu kollaborieren
...
- gratulieren:
    - ich wollte dir zur Hochzeit gratulieren 
...
### ober 
- oberflächlich:
    - er hat das Thema oberflächlich abgehandelt 

- oberhalb:
    - oberhalb 2000 Meter kann man nicht gut atmen 

- oberlauf:
    - am Oberlauf ist das Wasser sauber
...
- Helm:
    - der Helm 
    - ich trage immer den Helm 

- Hut:_
    - der Hut 
    - ich versuche Arbeit und Familie unter einen hut zu bringen 

- Strohhalm:
    - der Strohhalm 
    - ich klamme an den Strohhalm 
...
- ausbeuten:
    sie haben die Resspurcen ausgebeutet
...
### spinnen
- spinnen:
    - spinnst du, willst du soetwas machen  
...
- Spind:
    - der Spind 
    - hast du den Spind aufgebrochen 

### schnüffeln &&& spionieren 
- schnüffeln:
    - er schnüffelt in meiner Sache [in+dativ] 

- beschnüffeln:
    - er beschnüffelt meine Sache 

- spionieren:    
    - er spioniert in meiner Sache 
...
- überblättern:
    - ich werde das Kapitel überblättern
...
- installieren:
    - das habe ich schon installiert 

- vorinstallieren:
    - das ist schon auf dem System vorinstalliert 

- neu installieren:
    - ich werde es neu installieren 
...
- Neustart:
    - der Neustart 
    - nach dem Neustart kannst du das machen 
...
- Instinkt:
    - der Instinkt 
    - mein Instinkt sagt mir dass ich etwas falsches gemacht habe 
...
### quer 
- Quere:
    - Der Quere nach schneiden 
    - ich will dir nicht in der Quere stehen 
    - das wird uns in die Quere kommen

- querstellen:
    - sie wollten alle gehen aber ich habe mich quergestellt 
...
- einrosten: 
    - das Gelenke rostet ein

- durchrosten:
    - das Auto ist durchgerostet 

- entrosten:
    - ich werde es entrosten 
...
- anschicken:
    - ich habe mich angeschickt das zu machen [sich] [bereit machen]
...
- Struktur:
    - die Struktur 
    - die Struktur ist nicht sehr gut 
...
- strukturieren:
    - ich habe es gut strukturiert 

- umstrukturieren:
    - wir haben das System umstrukturiert 
    - ich strukturiere es um 
...
- System:
    - das System 
    - das ist ein kompliziertes System 

- systematisch:
    - wir müssen es systematisch abhandeln 
...
- laufende Nummer:*
    - so kann man laufende Nummer erstellen 

- nummerieren:
    - ich habe alle Seite nummeriert  

- durchnummerieren:
    - ich habe die Seite durchnummeriert 

### navi 
- Navi:
	- das Navi 
	- jetzt wird es Zeit das Navi wiede in Betrieb zu nehemen 

- navigieren:
    - wir kann man hier navigieren 

- Routine:
	- die Routine
	- das ist bei mir zur Routine geworden

- Route:
    - die Route 
    - welche Route sollen wir einschlagen 

### Profit 
- Profit:
    - der Profit 
    - der Profit war sehr gut 

- profitieren:
    - wir haben von dieser Arbeit viel profitieren 
...
### interpretieren 
- interpretieren:
    - das kann man als Frechheit interpretieren 

- fehlinterpretieren:
    - das wurde fehlinterpretiert 
...
- deeskalieren:
    - wir wollen die Situation deeskalieren 

### riesig 
- riesig:
    - das war ein rieiger Fehler 
...
- präsent:
    ...
    - der Name ist mir nicht präsent 
        - ich habe den Namen leider nicht präsent
...
- riskieren:
    ...
    - ich habe für ihn mein Leben riskiert
...
- Vorliebe:
    - die Vorliebe
    - ich habe Vorliebe für Autos

- nirgendwo:
    - wenn du das hier nicht schaffst, wirst du es nirgendwo schaffen 
...
- Uhr:
    - die Uhr 
    - ich will nicht ständig auf die Uhr schauen 
    - wir treffen uns um 8 Uhr morgen 
...
- Station:
    ...
    - ich muss an der nächsten Stationen umsteigen 

- Diät:
    - die Diät 
    - er hat mich auf Diät gesetzt 
    - ich bin auf Diät 
    - ich halte Diät 
...
- angetrunken:
- betrunken:
    - er ist nicht betrunken sondern angeheitert 
...
- Eindruck:
    - der Eindruck
    - ich habe den Eindruck dass er keine Lust hat 
    - er hat sehr guten Eindruck auf mich gemacht 
...
- Knopf:
    - der Knopf 
    - auf den Knopf drucken 

- Effekt:
	- der Effekt
    - ich habe viel versucht aber der Effekt bleibt aus 
    - so kann man den gewüschten Effekt erzielen 

- büßen:
    - ich muss für meine Fehler büßen

- korrigieren / berichtigen:
	- korrigier mich bitte wenn ich irre
	- ich habe den Fehler korrigiert
	- berichtige mich wenn ich etwas falsches sage
...
- Spass:
	...
	- ich hatte Spass bei der Arbeit 
...
- Schnee:
    ...
    - die Strasse ist teilweise vom Schnee befreit 


- Kurs:
    - der Kurs
    - wir wollen den Kurs halten 
    - ich bin vom Kurs abgekommen

- gutheißen:
- billigen:
    - ich heiße das Verhalten gut 
...
- Rezept:
    - das Rezept 
    - könntest du mir ein Rezept ausstelle
...
- Fieber:
    - das Fieber 
    - er hat Fieber 
    - ich werde bei ihm das Fieber messen 

- Termin:
    - der Termin
    - sollten wir einen Termin ausmachen 
    - ich habe um 7 Uhr einen Termin  
    - ich habe den Termin verpasst / eingehalten 

- Zelt:
    - das Zelt 
    - ich werde das Zelt aufstellen

- Fokus:
    - der Fokus
    - mein Fokus war nicht drauf
    - ich will nicht den Fokus verlieren
...
- widersetzen:
    - ich habe mich dem Gesetz widersetzt
...
- kommend:
    - im kommenden Monat muss ich fliegen 

- lästig:
    - er ist sehr lästiger Typ 
...
- kaputt:
    - es ist kaputt 
    - ich habe mein Auto kaputt gefahren 
...
- Sonne:
    - die Sonne scheint 
    - die Sonne wird am Himmel erscheinen

- EU:
    - die EU 
    - ich arbeite in der EU 

- träge:
    - der Markt ist sehr träge 
	- ich war träge und ich konnte nich schnell genug reagieren
...
- Westen:
    - der 
    - nach Norden, von Norden 
    - in den Norden, aus dem Norden 

- bewegen:
	- was hat dich dazu bewegt die Firma zu verlassen 
	- ich kann den schrank nicht alleine bewegen
...
- Absatz:
    - der Absatz 
    - ich werde einen neuen Absatz beginnen 

- Studium:
    - das Studium 
    - mein Studium war nicht einfach 

- Seminar:
    - das Seminar 
    - ich besuche ein Seminar hier 
...
- binnen:
    - binnen weniger Augenblicke war die Straße vom Schnee abgedeckt
...
- scheffeln:
    - ich habe viel Geld gescheffelt 
...
- Analogie:
    - ich konnte keine Analogie feststellen 
...
- auffassung:
    - die Auffassung 
    - ich habe eine andere Auffassung wie man das machen muss 
...
- Tasche:
    - die Tasche 
    - ich muss tief in die Tasche greifen 
...
- Rabatt:
	- der Rabatt
	- ich kann dir einen Rabatt auf alle Waren gewähren

- duschen:
	- ich dusche mich abends,morgens
	- ich dusche mich kalt

- Hintermann:
- vordermann:
    - Abstand zum Vordermann haltenauf

- Eintstieg
	- der Einstieg
	- der Einstieg in der Firma war gut 
	- ich wollte den Einstieg schaffen
...
- widersruch:
    - der widerspruch 
    - will jemand einen widerspruch einlegen 
...
- Ampel:
    - die Ampel 
    - er ist bei Rot die Ampel gefahren 
    - die Ampel zeigt Rot 
...
- Schema:
    ...
    - wir mussen uns an das Schema halten

- deal:
    - der Deal 
    - wir können guten Deal machen
...
- lindern:
- abfedern:
    - das wird die Folgen abfedern 
    - das lindert den Schmerzen
...
- Deadline:
    - der Stichtag 
    - die Deadline
    - wir haben eine Deadline gesetzt 
    - wir habe die Deadline gerissen
...
- abwärts:
- aufwärts:
    - der Weg kommt mir abwärts sehr anstregend an 
    - er ist von Hals abwärts gelähmt 
...
- nebenan:
    - wegen der Party nebenan konnte ich nicht schlafen 

- obenan:
    - wir haben Sport obenan auf der Liste 

- obenauf:
    - Hamburger hat obenauf einen Käse 
...
- anderswo:
    - du musst das Auto anders wo parken 

- irgendwo:
    - ich finde den Urlaub irgendwo am Meer machen 

- überall:
    - seine Sache liegen überall 
...
- nur:
    ...
    - ich mache was gutes 
    - man kann nicht nur erfreuliches Leben
    - mach Folgendes 

### Infinitiv mit zu
- es ist sehr schön Auto zu fahren 
- ich hatte lust Auto zu fahren 
- ich finde es gut Auto zu fahren
...
- Wiese:
    - die Wiese 
    - auf die Wiese, auf der Wiese, von der Wiese 

- Sonne:
    - die Sonne 
    - in die Sonne, in der Sonne, aus der Sonne 

- Regen:
    - der Regen 
    - in den Regen, im Regen, aus dem Regen

- Seite:
    - die Seite
    - auf die Linke Seite, auf der linken Seite, von der Linken Seite

- Schwimmen:
    - das Schwimmen 
    - zum Schwimmen, beim Schwimmen, vom Schwimmen

- Insel:
    - die Insel 
    - ich wollte meinen Urlaub auf einer Insel machen 
...
- seitens:
    - seitens der Behördern ist alles ok

- innerhalb:
- außerhalb:
- oberhalb:
- unterhalb:
    - innerhalbs des Dorfs
    - unterhalb von 100 metern
...
### es 
- adjektiv:
    - er ist nett, ich bin es leider nicht 
...
- es versuchen mit:
    - das macht mir keinen Spaß, ich werde es mit Sport versuchen 

- es sich[dativ] leicht machen:
    - ich mache es mir leicht in dem nur das wichtigste mache 

- es weit bringen:
    - ich habe es weit gebracht, er arbeitet jetzt bei Amazon

- es auf etwas abgesehen haben:
    - ich habe es auf das Auto abgesehen


    - ich habe es eilig 
    - ich meine es ernst 
    - ich habe es mit der Arbeit schwer 
    - ich meine es ernst
...
- aber:
    ...
    - die Kinder schlafen aber die Mutter ist immer noch wach 

- doch:
    - ich habe gebremst doch es war nicht genug 

- jedoch:
    - ich wollte ihm helfen, jedoch könnte ich das nicht schaffen

- dennoch:
    - ich bin arm und dennoch Glücklich 
    - die Arbeit war schwerig dennoch hatte ich viel Spaß dabei  

- trotzdem:
    - er hat keine Zeit tortzdem hat er mir geholfen 
    - ich weiss es nicht richtig, ich werde es trotzdem machen 

- tortz:
    - trotz des enormen Einsatzes, hat es nicht gereicht für einen Sieg 

- allerdings:
    - ich habe ihm eingeladen allerdings ist er nicht gekommen 

- stattdessen:
    - ich mache nicht die Hausaufhabe stattdessen schau ich Fernseher 

- obwohl:
    - obwohl es regnet, gehen wir draußen 

- dagegen:
    - ich mache viel SPort, meine Frau dagegen schläft die ganze Zeit 
    - ich spare Viel Geld, er dagegen gibt viel aus 

- sondern:
    - ich bin nicht mit dem Auto gefahren sondern mit dem Bus gekommen 
    - nicht ich sondern er hat es gemacht 
    - ich bin nicht mit dem Auto gekommen sondern ich habe ein Taxi genommen

### Kausale und konzessive Nebensätze
- so dass:
    - ich war so spät dass ich den Zug verpasst habe 

- dermäßen dass:
    - ich war dermäßen spät dass ich den Zu verpasst habe 

- so als dass:
    - es war so Groß als dass ich ins Auto kriegen kann

- zumal:
    - keiner warf ihm den Fehler vor zumal er sehr hart arbeitet
    - das Wetter ist sehr schön zumal im Sommer 

- da:
    - da ich keine Zeit habe, werde ich die Aufgabe an jemanden andere übergeben 
...
- wobei:
    ...
    - du hast nichts wichtiges verpasst wobei es nicht gut ist, spät zu kommen 

- ungeachtet dessen, dass:
    - ungeachtet dessen dass er sehr nett ist, muss man vorsichtig sein

- aus: [kontrolliert]
    - aus Leichtsinn 
    - ich habe aus Wut einen Brief geschriben
    - aus Angst habe ich das gemacht 

- vor:
    - vor Angst 
    - mein Gesicht war rot vor Wut
    - vor Angst konnte nich schlafen
    - ich habe vor Glück gelacht 

- wegen:
- aufgrund:
- infolge:
    - wegen des Wetters
    - ich muss infolge des Unfalls nach Hause gehe 

- zufolge:
    - dem Meetig zufolge

- angesichts:
    - angesichts der Sache müssen wir handeln
...
- gemäß:
    - gemäß dem Vertrag soll 

- ungeachtet:
    - er hat seines Erfolgs ungeachtet gekündiget 

- laut:
    - laut ihm sollen wir 

- zugunsten:
    - wir sammlen Geld zugunten eines Kinds 

- zulasten:
    - der Stress geht zulasten der Gesundheit
...
- zwecks:
    - zwecks einer besseren Plannung 
    - ich gehe zum Artz zwecks einer Untersuchtung 

- außer:
    - außer dir waren alle da 
    - ich habe außer meinen Kleidung nichts 

- bezüglich:
- hinsichtlich:
    - bezüglich deiner Email 
    - hinsichlich seinen Verhaltens 

- entsprechend:
    - wir haben alles deinem Wunsch entsprechend gemacht 
    - das ändert sich dem Alter sprechend

- daraufhin:
    - er ist nicht mehr da, daraufhin müssen wir einen Ersatz für ihn finden

- dementsprechend:
    - ich war single und dementsprechend habe ich Erfahrung gesammelt 

- jeweils:
    - es gibt neuen Stufe und jeweils drei davon sind in einer Eben zusammengefasst 

- auf etwas hin:
    - auf seinen Rat hin, haben wir das gemacht 
    - auf seine bitte hin haben wir das Meeting verschoben 

- auf die Gefahr hin:
    - auf die Gefahr hin falsch verstanden zu werden, sage ich trotdem meine Meinung

- von etwas her:
    - von seiner Sicher her 
...
- von etwas aus:
    - von mir aus kannst du alles machen was du willst 
    - vom Fenster aus kannst du die Stadt sehen 
    - von Natur aus ist er Ruhig 

- aus etwas heraus:
    - aus Angst heraus hat er das macht 

- auf etwas weise / Art:
    - auf komische Weise 

- aus jeder Hinsicht:
    - es war aus jeder Hinsicht ein Erfilg 

### Temporale Nebensätze 
- während:
    - während ich koche, sieht mich meine Katze an

- währenddessen:
    - ich mache das währenddessen kannst du die andere Aufgabe machen

- nachdem:
    - nachdem ich das gemacht, war ich alleine 

- bevor:
    - bevor ich das machen kann, soll 

- bis:
    - bis ich nicht fertig bin, wird er auf mich dringen

- wenn:
    - wenn ich das mache, brauche ich immer Pause 

- als:
    - als ich dich angerufen habe, war er nicht da 

- solange:
    - solange ich da bin, wird er das nicht machen 

- sobald:
    - sobald ich fertig bin, rufe ich dich an

- sooft:
    - sooft ich das versucht habe, bringt es nichts

### adjktiven 
#### so Grundform wie:
- so gut wie:
    - die Arbeit hier is so gut wie die Arbiet in Google

#### Komparativ + als
- besser als:
    - er ist besse als ich

#### Komparativ allein 
- langeren:
    - ich mache einen langeren Urlaub

#### Superlativ
- einer/eines/eine der schönsten:
    - er wöhnt in einer der schönsten Wöhnungen 
...
- jede zweite Minute = alle Zwei Minute
- jedes deitte Jahr = alle drei Jahre 
- jeder fünfte ist hier arm

- erstens, zweitens, drittens
- zu zweit. zu dritt, zu viert

#### Kardinalzahlen
- einer, zweier, dreier, vierer, fünfer. zehner, zwanziger, dreißiger, hunderter
...
- dativ:
    - dem, dem, der, den/denen 

- Genitiv:
    - des / dessen, des/ dessen, der/ deren, der/ deren  
...
#### pronomen  Negativartikel
- Nominativ:
    - keiner, keines, keine, keine 
- Akku:
    - keinen, kein, keine, keine
- dativ: 
    - keinem, keinem, keiner, keinen 
...
### Interrogativ pronomen [Fragepronomen]
- wer:
    - wer - wen - wem - wessen 
    - wessen Kind hat heute Geburtstag

- was:
    - was - was - was - wessen 
    - wesssen Laptop ist das
    - wessen Idee war das
    - was ist das für ein Mann / für eine Frau / fur ein Buch

- nomonativ:
    - welcher - welches - welche - welche 
    - welcher Mann hat dich interessiert 
...
- nomonativ:
    - mein Sohn - mein Buch - meine Tochter - meine Kinder 
    - meinen Sohn - mein Buch - meine Tocher - meine Kinder 
    - meinem Sohn - meinem Buch - meiner Tochter - meinen Kinder 
    - meines Sohnes - meines Buches - meiner Tpcher - meiner Kinder
    - meiner - meines - meine - meine 

### Indefinitpronomi
- man:
    - man - einen - einem 
    - das gefällt einem nicht 

- jemand:
    - jemand - jemanden - jemandem 
    - jemand hat mich mich 
...
- etwas:
- nichts:
    - ich habe etwas gehört / nichts

### wenig, einige, mehrere, ethlich, viel, was für ein
- zahlbare:
    - viele Freunde 
    - viele veletzte 

- einige neue Maßnahmen waren gut
- wir haben eingie neue Maßnahmen getroffen
- mit einigen guten Maßnahmen kann man viel erreichen 
- trotz eingier guter Maßnahmen 
...
### welche, irgenndwelche, jede, manche, solche, alle , beide
- solche ersten Probleme
- irgendewelche anderen Probleme

- solche neuen Maßnahmen waren 
- wir haben solchen neuen Maßnahmen 
- mit solchen neuen Maßnahmen
- trotz solcher neuene Maßnahmen

### alle
- every__:
    - alle Kinder haben verstanden 
    - ich habe mit allen meinen Freunden gesprochen
    - ich habe mit allen gesprochen 

- everthing:
    - alles ist falsch 
    - ich habe ihn mit allem versorgt

- Zeit :
    - ich muss alle 2 Stunden das machen 

### beide:
- Artikelwort:
    - beide guten Antworten sind richtig 
    - ich habe beide guten Antworten gekorrgiert 
    - ich bin mit beiden guten Anworten zufrieden
    - aufgrund beider guten

- attributiver Verwendung:
    - die beiden guten Antworten sind richtig 
    - ich habe die beiden guten Antworten korrigiert
    - ich bin mit den beiden guten Anworten zufrieden 
    - aufgrund der beiden jungen 

- beide[plural] / beides[singular]:
    - ich mage / finde / liebe  beides 
    - beide gefällen mir 
    - zwei leute ich kann mit beiden arbeiten
    - zwei unterschiedliche dingen ich habe mit beidem arbeiten
    - zwei ähnliche dingen ich habe mit beiden arbeiten
...
- unzahlbar:
    - alles Geld ist vergänglich 
    - alle Liebe ist 
    - mit aller Liebe 
    - mit aller meiner Kraft 
    - ich habe alle meine Kraft benutzt

- alle:
    - alle sind verstanden worden
    - ich habe mit allen gesprochen 
...
- all:
    - all diese Arbeit war umsont 
    - all mein zureden hat nichts gebracht 
...
### pfiffen 
- verpfiffen:   
    - er hat mich beim Chef verpfifft 

- verpetzen:
    - er hat mich beim Chef verpetzt 
...
### prügeln
- prügeln:
    - ich habe mit ihm geprügelt 

- einprügeln;
    - ich habe auf ihn eingeprügelt
...
### schleudern:
- schleudern:
    - das auto kann ins schleudern 
    - Die Waschmaschine ist gerade beim Schleudern, das ist ziemlich laut.

- verschleudern:
    - ich will mein Geld nicht verschleudern

### reimen 
- reimen:
    - das reimt sich gut mit Liebe 

- zusammenreimen:
    - wir können uns eine Lösung zusammenreimen 
    - ie hat mir nichts gesagt, aber nach ihrem Telefonat konnte ich mir den Rest zusammenreimen 

### abkönnen 
- abkönnen:
    - ich kann ihn überhaupt nicht ab 

- wegkönnen:
    - ich kann jetzt endlich weg
